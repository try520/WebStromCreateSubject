...
var GetRsCount=function(Filter,CallBack){
    var Sql = "Select Count(*) as Count From SysMsg Where " + Filter + "";
...
exports.GetRsCount = function () {
    ...
    console.log("Access/SysMsg.js=>GetRsCount 缺少参数");
    CallBack(false,null);
}
/*-----统计求和--------------*/
var Sum=function(Field,Filter,CallBack){
    var Sql = "Select Sum("+Field+") as SumCount From SysMsg Where "+Filter+"";
    client.Query ( Sql , function ( err , Result ) {
...
exports.Sum = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/SysMsg.js=>Sum 缺少参数");
    CallBack(false,null);
}

/*-----查询所有记录--------------*/
var SelectAll = function ( CallBack ) {
    var Sql = "Select * From SysMsg";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var SelectAll_Field = function (Field, CallBack ) {
    var Sql = "Select "+Field+" From SysMsg";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var SelectAllByOrder = function (Field ,  Order , CallBack ) {
    var Sql = "Select "+Field+" From SysMsg  Order By " + Order;
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports.SelectAll = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/SysMsg.js=>SelectAll 缺少参数");
    CallBack(false,null);
}
/*-----根据关键字查询记录--------------*/

var Select = function ( MsgID , CallBack ) {
    var Sql = "Select * From SysMsg Where MsgID=?MsgID";
    var Values = {};
    Values.MsgID = MsgID;
    client.Query ( Sql , Values , function ( err , Result ) {
        if ( Result.length > 0 ) {
    ...
    var Select_Field = function (Field, MsgID , CallBack ) {
    var Sql = "Select "+Field+" From SysMsg Where MsgID=?MsgID";
    var Values = {};
    Values.MsgID = MsgID;
    client.Query ( Sql , Values , function ( err , Result ) {
        if ( Result.length > 0 ) {
...
exports.Select = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/SysMsg.js=>Select 缺少参数");
    CallBack(false,null);
}

/*-----根据条件查询记录--------------*/
var SelectByFilter = function ( Filter , CallBack ) {
    var Sql = "Select * From SysMsg Where " + Filter + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var SelectByFilter_Field = function (Field, Filter , CallBack ) {
    var Sql = "Select "+Field+" From SysMsg Where " + Filter + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports.SelectByFilter = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/SysMsg.js=>SelectByFilter 缺少参数");
    CallBack(false,null);
}
...
exports.Insert = function ( Model , CallBack ) {
    var Sql = "Insert Into SysMsg Set MsgID=?MsgID,MsgType=?MsgType,MsgInfo=?MsgInfo,MsgWtime=?MsgWtime ";
...
exports.Update = function ( Model , CallBack ) {
    var Sql = "Update SysMsg Set  MsgID=?MsgID,MsgType=?MsgType,MsgInfo=?MsgInfo,MsgWtime=?MsgWtime Where MsgID=?MsgID";
    client.Query ( Sql , Model , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
/**
 * 更新字段值 MsgID
 * @param Key  主键值 Key:MsgID
 * @param Value MsgID的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_MsgID = function ( MsgID , Value , CallBack ) {
    var Sql = "Update SysMsg Set MsgID=?MsgID where MsgID=?MsgID";
    var Model = {};
    Model.Value = Value;
    Model.MsgID = MsgID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * @constructor
 */
exports.Set_MsgType = function ( MsgID , Value , CallBack ) {
    var Sql = "Update SysMsg Set MsgType=?MsgType where MsgID=?MsgID";
    var Model = {};
    Model.Value = Value;
    Model.MsgID = MsgID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * 更新字段值 MsgInfo
 * @param Key  主键值 Key:MsgID
 * @param Value MsgInfo的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_MsgInfo = function ( MsgID , Value , CallBack ) {
    var Sql = "Update SysMsg Set MsgInfo=?MsgInfo where MsgID=?MsgID";
    var Model = {};
    Model.Value = Value;
    Model.MsgID = MsgID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * 更新字段值 MsgWtime
 * @param Key  主键值 Key:MsgID
 * @param Value MsgWtime的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_MsgWtime = function ( MsgID , Value , CallBack ) {
    var Sql = "Update SysMsg Set MsgWtime=?MsgWtime where MsgID=?MsgID";
    var Model = {};
    Model.Value = Value;
    Model.MsgID = MsgID;
    client.Query ( Sql , Model , function ( err , Result ) {
...
exports.Delete=function(MsgID,CallBack){
    var Sql = "Delete From SysMsg Where MsgID=?MsgID";
    var Model={};
    Model.MsgID=MsgID;
    client.Query ( Sql , Model , function ( err , Result ) {
        CallBack ( err , Result );
...
var DeleteByFilter=function(Filter,CallBack){
    var Sql = "Delete From SysMsg where "+Filter+"";
    client.Query ( Sql  , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports. DeleteByFilter=function(){
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/SysMsg.js=>DeleteByFilter 缺少参数");
    CallBack(false,null);
}
...
var GetPageRow = function ( CurPage , PageSize , Filter , CallBack ) {
    ...
    var Sql = "Select *  from SysMsg  where " + Filter + "  limit " + (PageSize * (CurPage - 1)) + "," + PageSize + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var GetPageRow_Field = function ( Field , CurPage , PageSize , Filter , CallBack ) {
    if(Filter=="")  Filter="1=1";
    var Sql = "Select " + Field + "  from SysMsg  where " + Filter + "  limit " + (PageSize * (CurPage - 1)) + "," + PageSize + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports.GetPageRow=function(){
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/SysMsg.js=>GetPageRow 缺少参数");
    CallBack(false,null);
}
