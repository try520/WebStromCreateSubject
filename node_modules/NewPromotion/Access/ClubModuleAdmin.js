...
var GetRsCount=function(Filter,CallBack){
    var Sql = "Select Count(*) as Count From ClubModuleAdmin Where " + Filter + "";
...
exports.GetRsCount = function () {
    ...
    console.log("Access/ClubModuleAdmin.js=>GetRsCount 缺少参数");
    CallBack(false,null);
}
/*-----统计求和--------------*/
var Sum=function(Field,Filter,CallBack){
    var Sql = "Select Sum("+Field+") as SumCount From ClubModuleAdmin Where "+Filter+"";
    client.Query ( Sql , function ( err , Result ) {
...
exports.Sum = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/ClubModuleAdmin.js=>Sum 缺少参数");
    CallBack(false,null);
}

/*-----查询所有记录--------------*/
var SelectAll = function ( CallBack ) {
    var Sql = "Select * From ClubModuleAdmin";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var SelectAll_Field = function (Field, CallBack ) {
    var Sql = "Select "+Field+" From ClubModuleAdmin";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var SelectAllByOrder = function (Field ,  Order , CallBack ) {
    var Sql = "Select "+Field+" From ClubModuleAdmin  Order By " + Order;
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports.SelectAll = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/ClubModuleAdmin.js=>SelectAll 缺少参数");
    CallBack(false,null);
}
/*-----根据关键字查询记录--------------*/

var Select = function ( ModuleAdminID , CallBack ) {
    var Sql = "Select * From ClubModuleAdmin Where ModuleAdminID=?ModuleAdminID";
    var Values = {};
    Values.ModuleAdminID = ModuleAdminID;
    client.Query ( Sql , Values , function ( err , Result ) {
        if ( Result.length > 0 ) {
    ...
    var Select_Field = function (Field, ModuleAdminID , CallBack ) {
    var Sql = "Select "+Field+" From ClubModuleAdmin Where ModuleAdminID=?ModuleAdminID";
    var Values = {};
    Values.ModuleAdminID = ModuleAdminID;
    client.Query ( Sql , Values , function ( err , Result ) {
        if ( Result.length > 0 ) {
...
exports.Select = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/ClubModuleAdmin.js=>Select 缺少参数");
    CallBack(false,null);
}

/*-----根据条件查询记录--------------*/
var SelectByFilter = function ( Filter , CallBack ) {
    var Sql = "Select * From ClubModuleAdmin Where " + Filter + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var SelectByFilter_Field = function (Field, Filter , CallBack ) {
    var Sql = "Select "+Field+" From ClubModuleAdmin Where " + Filter + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports.SelectByFilter = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/ClubModuleAdmin.js=>SelectByFilter 缺少参数");
    CallBack(false,null);
}
...
exports.Insert = function ( Model , CallBack ) {
    var Sql = "Insert Into ClubModuleAdmin Set UserID=?UserID,ModuleID=?ModuleID ";
...
exports.Update = function ( Model , CallBack ) {
    var Sql = "Update ClubModuleAdmin Set  UserID=?UserID,ModuleID=?ModuleID Where ModuleAdminID=?ModuleAdminID";
    client.Query ( Sql , Model , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
/**
 * 更新字段值 UserID
 * @param Key  主键值 Key:ModuleAdminID
 * @param Value UserID的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_UserID = function ( ModuleAdminID , Value , CallBack ) {
    var Sql = "Update ClubModuleAdmin Set UserID=?UserID where ModuleAdminID=?ModuleAdminID";
    var Model = {};
    Model.Value = Value;
    Model.ModuleAdminID = ModuleAdminID;
    client.Query ( Sql , Model , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
 ...
 * 更新字段值 ModuleID
 * @param Key  主键值 Key:ModuleAdminID
 * @param Value ModuleID的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_ModuleID = function ( ModuleAdminID , Value , CallBack ) {
    var Sql = "Update ClubModuleAdmin Set ModuleID=?ModuleID where ModuleAdminID=?ModuleAdminID";
    var Model = {};
    Model.Value = Value;
    Model.ModuleAdminID = ModuleAdminID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * @constructor
 */
exports.Delete=function(ModuleAdminID,CallBack){
    var Sql = "Delete From ClubModuleAdmin Where ModuleAdminID=?ModuleAdminID";
    var Model={};
    Model.ModuleAdminID=ModuleAdminID;
    client.Query ( Sql , Model , function ( err , Result ) {
        CallBack ( err , Result );
...
exports.DeleteAll=function(CallBack){
    var Sql = "Delete From ClubModuleAdmin";
    client.Query ( Sql  , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var DeleteByFilter=function(Filter,CallBack){
    var Sql = "Delete From ClubModuleAdmin where "+Filter+"";
    client.Query ( Sql  , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports. DeleteByFilter=function(){
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/ClubModuleAdmin.js=>DeleteByFilter 缺少参数");
    CallBack(false,null);
}
...
var GetPageRow = function ( CurPage , PageSize , Filter , CallBack ) {
    ...
    var Sql = "Select *  from ClubModuleAdmin  where " + Filter + "  limit " + (PageSize * (CurPage - 1)) + "," + PageSize + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var GetPageRow_Field = function ( Field , CurPage , PageSize , Filter , CallBack ) {
    if(Filter=="")  Filter="1=1";
    var Sql = "Select " + Field + "  from ClubModuleAdmin  where " + Filter + "  limit " + (PageSize * (CurPage - 1)) + "," + PageSize + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports.GetPageRow=function(){
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/ClubModuleAdmin.js=>GetPageRow 缺少参数");
    CallBack(false,null);
}
