...
var GetRsCount=function(Filter,CallBack){
    var Sql = "Select Count(*) as Count From ClubThreadSupport Where " + Filter + "";
...
exports.GetRsCount = function () {
    ...
    console.log("Access/ClubThreadSupport.js=>GetRsCount 缺少参数");
    CallBack(false,null);
}
/*-----统计求和--------------*/
var Sum=function(Field,Filter,CallBack){
    var Sql = "Select Sum("+Field+") as SumCount From ClubThreadSupport Where "+Filter+"";
    client.Query ( Sql , function ( err , Result ) {
...
exports.Sum = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/ClubThreadSupport.js=>Sum 缺少参数");
    CallBack(false,null);
}

/*-----查询所有记录--------------*/
var SelectAll = function ( CallBack ) {
    var Sql = "Select * From ClubThreadSupport";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var SelectAll_Field = function (Field, CallBack ) {
    var Sql = "Select "+Field+" From ClubThreadSupport";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var SelectAllByOrder = function (Field ,  Order , CallBack ) {
    var Sql = "Select "+Field+" From ClubThreadSupport  Order By " + Order;
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports.SelectAll = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/ClubThreadSupport.js=>SelectAll 缺少参数");
    CallBack(false,null);
}
/*-----根据关键字查询记录--------------*/

var Select = function ( SupportID , CallBack ) {
    var Sql = "Select * From ClubThreadSupport Where SupportID=?SupportID";
    var Values = {};
    Values.SupportID = SupportID;
    client.Query ( Sql , Values , function ( err , Result ) {
        if ( Result.length > 0 ) {
    ...
    var Select_Field = function (Field, SupportID , CallBack ) {
    var Sql = "Select "+Field+" From ClubThreadSupport Where SupportID=?SupportID";
    var Values = {};
    Values.SupportID = SupportID;
    client.Query ( Sql , Values , function ( err , Result ) {
        if ( Result.length > 0 ) {
...
exports.Select = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/ClubThreadSupport.js=>Select 缺少参数");
    CallBack(false,null);
}

/*-----根据条件查询记录--------------*/
var SelectByFilter = function ( Filter , CallBack ) {
    var Sql = "Select * From ClubThreadSupport Where " + Filter + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var SelectByFilter_Field = function (Field, Filter , CallBack ) {
    var Sql = "Select "+Field+" From ClubThreadSupport Where " + Filter + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports.SelectByFilter = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/ClubThreadSupport.js=>SelectByFilter 缺少参数");
    CallBack(false,null);
}
...
exports.Insert = function ( Model , CallBack ) {
    var Sql = "Insert Into ClubThreadSupport Set SupportID=?SupportID,UserID=?UserID,UserName=?UserName,TagType=?TagType,Tag=?Tag,SupportType=?SupportType ";
...
exports.Update = function ( Model , CallBack ) {
    var Sql = "Update ClubThreadSupport Set  SupportID=?SupportID,UserID=?UserID,UserName=?UserName,TagType=?TagType,Tag=?Tag,SupportType=?SupportType Where SupportID=?SupportID";
    client.Query ( Sql , Model , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
/**
 * 更新字段值 SupportID
 * @param Key  主键值 Key:SupportID
 * @param Value SupportID的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_SupportID = function ( SupportID , Value , CallBack ) {
    var Sql = "Update ClubThreadSupport Set SupportID=?SupportID where SupportID=?SupportID";
    var Model = {};
    Model.Value = Value;
    Model.SupportID = SupportID;
    client.Query ( Sql , Model , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
 ...
 * @constructor
 */
exports.Set_UserID = function ( SupportID , Value , CallBack ) {
    var Sql = "Update ClubThreadSupport Set UserID=?UserID where SupportID=?SupportID";
    var Model = {};
    Model.Value = Value;
    Model.SupportID = SupportID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * @constructor
 */
exports.Set_UserName = function ( SupportID , Value , CallBack ) {
    var Sql = "Update ClubThreadSupport Set UserName=?UserName where SupportID=?SupportID";
    var Model = {};
    Model.Value = Value;
    Model.SupportID = SupportID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * 更新字段值 TagType
 * @param Key  主键值 Key:SupportID
 * @param Value TagType的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_TagType = function ( SupportID , Value , CallBack ) {
    var Sql = "Update ClubThreadSupport Set TagType=?TagType where SupportID=?SupportID";
    var Model = {};
    Model.Value = Value;
    Model.SupportID = SupportID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * @constructor
 */
exports.Set_Tag = function ( SupportID , Value , CallBack ) {
    var Sql = "Update ClubThreadSupport Set Tag=?Tag where SupportID=?SupportID";
    var Model = {};
    Model.Value = Value;
    Model.SupportID = SupportID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * 更新字段值 SupportType
 * @param Key  主键值 Key:SupportID
 * @param Value SupportType的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_SupportType = function ( SupportID , Value , CallBack ) {
    var Sql = "Update ClubThreadSupport Set SupportType=?SupportType where SupportID=?SupportID";
    var Model = {};
    Model.Value = Value;
    Model.SupportID = SupportID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * @constructor
 */
exports.Delete=function(SupportID,CallBack){
    var Sql = "Delete From ClubThreadSupport Where SupportID=?SupportID";
    var Model={};
    Model.SupportID=SupportID;
    client.Query ( Sql , Model , function ( err , Result ) {
        CallBack ( err , Result );
...
exports.DeleteAll=function(CallBack){
    var Sql = "Delete From ClubThreadSupport";
    client.Query ( Sql  , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var DeleteByFilter=function(Filter,CallBack){
    var Sql = "Delete From ClubThreadSupport where "+Filter+"";
    client.Query ( Sql  , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports. DeleteByFilter=function(){
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/ClubThreadSupport.js=>DeleteByFilter 缺少参数");
    CallBack(false,null);
}
...
var GetPageRow = function ( CurPage , PageSize , Filter , CallBack ) {
    ...
    var Sql = "Select *  from ClubThreadSupport  where " + Filter + "  limit " + (PageSize * (CurPage - 1)) + "," + PageSize + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var GetPageRow_Field = function ( Field , CurPage , PageSize , Filter , CallBack ) {
    if(Filter=="")  Filter="1=1";
    var Sql = "Select " + Field + "  from ClubThreadSupport  where " + Filter + "  limit " + (PageSize * (CurPage - 1)) + "," + PageSize + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports.GetPageRow=function(){
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/ClubThreadSupport.js=>GetPageRow 缺少参数");
    CallBack(false,null);
}
