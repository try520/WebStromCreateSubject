...
var GetRsCount=function(Filter,CallBack){
    var Sql = "Select Count(*) as Count From R_Group_User Where " + Filter + "";
...
exports.GetRsCount = function () {
    ...
    console.log("Access/R_Group_User.js=>GetRsCount 缺少参数");
    CallBack(false,null);
}
/*-----统计求和--------------*/
var Sum=function(Field,Filter,CallBack){
    var Sql = "Select Sum("+Field+") as SumCount From R_Group_User Where "+Filter+"";
    client.Query ( Sql , function ( err , Result ) {
...
exports.Sum = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/R_Group_User.js=>Sum 缺少参数");
    CallBack(false,null);
}

/*-----查询所有记录--------------*/
var SelectAll = function ( CallBack ) {
    var Sql = "Select * From R_Group_User";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var SelectAll_Field = function (Field, CallBack ) {
    var Sql = "Select "+Field+" From R_Group_User";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var SelectAllByOrder = function (Field ,  Order , CallBack ) {
    var Sql = "Select "+Field+" From R_Group_User  Order By " + Order;
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports.SelectAll = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/R_Group_User.js=>SelectAll 缺少参数");
    CallBack(false,null);
}
/*-----根据关键字查询记录--------------*/

var Select = function ( ID , CallBack ) {
    var Sql = "Select * From R_Group_User Where ID=?ID";
    var Values = {};
    Values.ID = ID;
    client.Query ( Sql , Values , function ( err , Result ) {
        if ( Result.length > 0 ) {
    ...
    var Sql = "Select "+Field+" From R_Group_User Where ID=?ID";
    var Values = {};
    Values.ID = ID;
    client.Query ( Sql , Values , function ( err , Result ) {
        if ( Result.length > 0 ) {
...
exports.Select = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/R_Group_User.js=>Select 缺少参数");
    CallBack(false,null);
}

/*-----根据条件查询记录--------------*/
var SelectByFilter = function ( Filter , CallBack ) {
    var Sql = "Select * From R_Group_User Where " + Filter + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var SelectByFilter_Field = function (Field, Filter , CallBack ) {
    var Sql = "Select "+Field+" From R_Group_User Where " + Filter + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports.SelectByFilter = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/R_Group_User.js=>SelectByFilter 缺少参数");
    CallBack(false,null);
}
...
exports.Insert = function ( Model , CallBack ) {
    var Sql = "Insert Into R_Group_User Set R_UserID=?R_UserID,R_GroupID=?R_GroupID,Rules=?Rules,Wtime=?Wtime ";
...
exports.Update = function ( Model , CallBack ) {
    var Sql = "Update R_Group_User Set  R_UserID=?R_UserID,R_GroupID=?R_GroupID,Rules=?Rules,Wtime=?Wtime Where ID=?ID";
    client.Query ( Sql , Model , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
 ...
 * @param Value R_UserID的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_R_UserID = function ( ID , Value , CallBack ) {
    var Sql = "Update R_Group_User Set R_UserID=?R_UserID where ID=?ID";
    var Model = {};
    Model.Value = Value;
    Model.ID = ID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * 更新字段值 R_GroupID
 * @param Key  主键值 Key:ID
 * @param Value R_GroupID的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_R_GroupID = function ( ID , Value , CallBack ) {
    var Sql = "Update R_Group_User Set R_GroupID=?R_GroupID where ID=?ID";
    var Model = {};
    Model.Value = Value;
    Model.ID = ID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * @constructor
 */
exports.Set_Rules = function ( ID , Value , CallBack ) {
    var Sql = "Update R_Group_User Set Rules=?Rules where ID=?ID";
    var Model = {};
    Model.Value = Value;
    Model.ID = ID;
    client.Query ( Sql , Model , function ( err , Result ) {
...
exports.Set_Wtime = function ( ID , Value , CallBack ) {
    var Sql = "Update R_Group_User Set Wtime=?Wtime where ID=?ID";
    var Model = {};
    Model.Value = Value;
    Model.ID = ID;
    client.Query ( Sql , Model , function ( err , Result ) {
...
exports.Delete=function(ID,CallBack){
    var Sql = "Delete From R_Group_User Where ID=?ID";
    var Model={};
    Model.ID=ID;
    client.Query ( Sql , Model , function ( err , Result ) {
        CallBack ( err , Result );
...
exports.DeleteAll=function(CallBack){
    var Sql = "Delete From R_Group_User";
    client.Query ( Sql  , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var DeleteByFilter=function(Filter,CallBack){
    var Sql = "Delete From R_Group_User where "+Filter+"";
    client.Query ( Sql  , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports. DeleteByFilter=function(){
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/R_Group_User.js=>DeleteByFilter 缺少参数");
    CallBack(false,null);
}
...
var GetPageRow = function ( CurPage , PageSize , Filter , CallBack ) {
    ...
    var Sql = "Select *  from R_Group_User  where " + Filter + "  limit " + (PageSize * (CurPage - 1)) + "," + PageSize + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var GetPageRow_Field = function ( Field , CurPage , PageSize , Filter , CallBack ) {
    if(Filter=="")  Filter="1=1";
    var Sql = "Select " + Field + "  from R_Group_User  where " + Filter + "  limit " + (PageSize * (CurPage - 1)) + "," + PageSize + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports.GetPageRow=function(){
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/R_Group_User.js=>GetPageRow 缺少参数");
    CallBack(false,null);
}
