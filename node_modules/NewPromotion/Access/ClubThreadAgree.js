...
var GetRsCount=function(Filter,CallBack){
    var Sql = "Select Count(*) as Count From ClubThreadAgree Where " + Filter + "";
...
exports.GetRsCount = function () {
    ...
    console.log("Access/ClubThreadAgree.js=>GetRsCount 缺少参数");
    CallBack(false,null);
}
/*-----统计求和--------------*/
var Sum=function(Field,Filter,CallBack){
    var Sql = "Select Sum("+Field+") as SumCount From ClubThreadAgree Where "+Filter+"";
    client.Query ( Sql , function ( err , Result ) {
...
exports.Sum = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/ClubThreadAgree.js=>Sum 缺少参数");
    CallBack(false,null);
}

/*-----查询所有记录--------------*/
var SelectAll = function ( CallBack ) {
    var Sql = "Select * From ClubThreadAgree";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var SelectAll_Field = function (Field, CallBack ) {
    var Sql = "Select "+Field+" From ClubThreadAgree";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var SelectAllByOrder = function (Field ,  Order , CallBack ) {
    var Sql = "Select "+Field+" From ClubThreadAgree  Order By " + Order;
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports.SelectAll = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/ClubThreadAgree.js=>SelectAll 缺少参数");
    CallBack(false,null);
}
/*-----根据关键字查询记录--------------*/

var Select = function ( AgreeID , CallBack ) {
    var Sql = "Select * From ClubThreadAgree Where AgreeID=?AgreeID";
    var Values = {};
    Values.AgreeID = AgreeID;
    client.Query ( Sql , Values , function ( err , Result ) {
        if ( Result.length > 0 ) {
    ...
    var Select_Field = function (Field, AgreeID , CallBack ) {
    var Sql = "Select "+Field+" From ClubThreadAgree Where AgreeID=?AgreeID";
    var Values = {};
    Values.AgreeID = AgreeID;
    client.Query ( Sql , Values , function ( err , Result ) {
        if ( Result.length > 0 ) {
...
exports.Select = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/ClubThreadAgree.js=>Select 缺少参数");
    CallBack(false,null);
}

/*-----根据条件查询记录--------------*/
var SelectByFilter = function ( Filter , CallBack ) {
    var Sql = "Select * From ClubThreadAgree Where " + Filter + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var SelectByFilter_Field = function (Field, Filter , CallBack ) {
    var Sql = "Select "+Field+" From ClubThreadAgree Where " + Filter + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports.SelectByFilter = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/ClubThreadAgree.js=>SelectByFilter 缺少参数");
    CallBack(false,null);
}
...
exports.Insert = function ( Model , CallBack ) {
    var Sql = "Insert Into ClubThreadAgree Set Tag=?Tag,TagType=?TagType,Point=?Point,UserID=?UserID,UserName=?UserName,Content=?Content,CreateTime=?CreateTime ";
...
exports.Update = function ( Model , CallBack ) {
    var Sql = "Update ClubThreadAgree Set  Tag=?Tag,TagType=?TagType,Point=?Point,UserID=?UserID,UserName=?UserName,Content=?Content,CreateTime=?CreateTime Where AgreeID=?AgreeID";
    client.Query ( Sql , Model , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
/**
 * 更新字段值 Tag
 * @param Key  主键值 Key:AgreeID
 * @param Value Tag的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_Tag = function ( AgreeID , Value , CallBack ) {
    var Sql = "Update ClubThreadAgree Set Tag=?Tag where AgreeID=?AgreeID";
    var Model = {};
    Model.Value = Value;
    Model.AgreeID = AgreeID;
    client.Query ( Sql , Model , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
 ...
 * @constructor
 */
exports.Set_TagType = function ( AgreeID , Value , CallBack ) {
    var Sql = "Update ClubThreadAgree Set TagType=?TagType where AgreeID=?AgreeID";
    var Model = {};
    Model.Value = Value;
    Model.AgreeID = AgreeID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * @constructor
 */
exports.Set_Point = function ( AgreeID , Value , CallBack ) {
    var Sql = "Update ClubThreadAgree Set Point=?Point where AgreeID=?AgreeID";
    var Model = {};
    Model.Value = Value;
    Model.AgreeID = AgreeID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * @constructor
 */
exports.Set_UserID = function ( AgreeID , Value , CallBack ) {
    var Sql = "Update ClubThreadAgree Set UserID=?UserID where AgreeID=?AgreeID";
    var Model = {};
    Model.Value = Value;
    Model.AgreeID = AgreeID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * @constructor
 */
exports.Set_UserName = function ( AgreeID , Value , CallBack ) {
    var Sql = "Update ClubThreadAgree Set UserName=?UserName where AgreeID=?AgreeID";
    var Model = {};
    Model.Value = Value;
    Model.AgreeID = AgreeID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * 更新字段值 Content
 * @param Key  主键值 Key:AgreeID
 * @param Value Content的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_Content = function ( AgreeID , Value , CallBack ) {
    var Sql = "Update ClubThreadAgree Set Content=?Content where AgreeID=?AgreeID";
    var Model = {};
    Model.Value = Value;
    Model.AgreeID = AgreeID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * @constructor
 */
exports.Set_CreateTime = function ( AgreeID , Value , CallBack ) {
    var Sql = "Update ClubThreadAgree Set CreateTime=?CreateTime where AgreeID=?AgreeID";
    var Model = {};
    Model.Value = Value;
    Model.AgreeID = AgreeID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * @constructor
 */
exports.Delete=function(AgreeID,CallBack){
    var Sql = "Delete From ClubThreadAgree Where AgreeID=?AgreeID";
    var Model={};
    Model.AgreeID=AgreeID;
    client.Query ( Sql , Model , function ( err , Result ) {
        CallBack ( err , Result );
...
exports.DeleteAll=function(CallBack){
    var Sql = "Delete From ClubThreadAgree";
    client.Query ( Sql  , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var DeleteByFilter=function(Filter,CallBack){
    var Sql = "Delete From ClubThreadAgree where "+Filter+"";
    client.Query ( Sql  , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports. DeleteByFilter=function(){
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/ClubThreadAgree.js=>DeleteByFilter 缺少参数");
    CallBack(false,null);
}
...
var GetPageRow = function ( CurPage , PageSize , Filter , CallBack ) {
    ...
    var Sql = "Select *  from ClubThreadAgree  where " + Filter + "  limit " + (PageSize * (CurPage - 1)) + "," + PageSize + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var GetPageRow_Field = function ( Field , CurPage , PageSize , Filter , CallBack ) {
    if(Filter=="")  Filter="1=1";
    var Sql = "Select " + Field + "  from ClubThreadAgree  where " + Filter + "  limit " + (PageSize * (CurPage - 1)) + "," + PageSize + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports.GetPageRow=function(){
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/ClubThreadAgree.js=>GetPageRow 缺少参数");
    CallBack(false,null);
}
