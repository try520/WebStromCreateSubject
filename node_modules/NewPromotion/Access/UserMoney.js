...
var GetRsCount=function(Filter,CallBack){
    var Sql = "Select Count(*) as Count From UserMoney Where " + Filter + "";
...
exports.GetRsCount = function () {
    ...
    console.log("Access/UserMoney.js=>GetRsCount 缺少参数");
    CallBack(false,null);
}
/*-----统计求和--------------*/
var Sum=function(Field,Filter,CallBack){
    var Sql = "Select Sum("+Field+") as SumCount From UserMoney Where "+Filter+"";
    client.Query ( Sql , function ( err , Result ) {
...
exports.Sum = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/UserMoney.js=>Sum 缺少参数");
    CallBack(false,null);
}

/*-----查询所有记录--------------*/
var SelectAll = function ( CallBack ) {
    var Sql = "Select * From UserMoney";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var SelectAll_Field = function (Field, CallBack ) {
    var Sql = "Select "+Field+" From UserMoney";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var SelectAllByOrder = function (Field ,  Order , CallBack ) {
    var Sql = "Select "+Field+" From UserMoney  Order By " + Order;
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports.SelectAll = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/UserMoney.js=>SelectAll 缺少参数");
    CallBack(false,null);
}
/*-----根据关键字查询记录--------------*/

var Select = function ( UserID , CallBack ) {
    var Sql = "Select * From UserMoney Where UserID=?UserID";
    var Values = {};
    ...
    var Sql = "Select "+Field+" From UserMoney Where UserID=?UserID";
    var Values = {};
    Values.UserID = UserID;
    client.Query ( Sql , Values , function ( err , Result ) {
        if ( Result.length > 0 ) {
...
exports.Select = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/UserMoney.js=>Select 缺少参数");
    CallBack(false,null);
}

/*-----根据条件查询记录--------------*/
var SelectByFilter = function ( Filter , CallBack ) {
    var Sql = "Select * From UserMoney Where " + Filter + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var SelectByFilter_Field = function (Field, Filter , CallBack ) {
    var Sql = "Select "+Field+" From UserMoney Where " + Filter + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports.SelectByFilter = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/UserMoney.js=>SelectByFilter 缺少参数");
    CallBack(false,null);
}
...
exports.Insert = function ( Model , CallBack ) {
    var Sql = "Insert Into UserMoney Set UserID=?UserID,UserCurMoney=?UserCurMoney,UserNeedPayMoney=?UserNeedPayMoney,UserPayMoney=?UserPayMoney,arrears=?arrears,Integral=?Integral,TaskMoney=?TaskMoney ";
...
exports.Update = function ( Model , CallBack ) {
    var Sql = "Update UserMoney Set  UserID=?UserID,UserCurMoney=?UserCurMoney,UserNeedPayMoney=?UserNeedPayMoney,UserPayMoney=?UserPayMoney,arrears=?arrears,Integral=?Integral,TaskMoney=?TaskMoney Where UserID=?UserID";
    client.Query ( Sql , Model , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports.Set_UserID = function ( UserID , Value , CallBack ) {
    var Sql = "Update UserMoney Set UserID=?UserID where UserID=?UserID";
    var Model = {};
    Model.Value = Value;
    Model.UserID = UserID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * 更新字段值 UserCurMoney
 * @param Key  主键值 Key:UserID
 * @param Value UserCurMoney的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_UserCurMoney = function ( UserID , Value , CallBack ) {
    var Sql = "Update UserMoney Set UserCurMoney=?UserCurMoney where UserID=?UserID";
    var Model = {};
    Model.Value = Value;
    Model.UserID = UserID;
    client.Query ( Sql , Model , function ( err , Result ) {
...
/**
 * 更新字段值 UserNeedPayMoney
 * @param Key  主键值 Key:UserID
 * @param Value UserNeedPayMoney的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_UserNeedPayMoney = function ( UserID , Value , CallBack ) {
    var Sql = "Update UserMoney Set UserNeedPayMoney=?UserNeedPayMoney where UserID=?UserID";
    var Model = {};
    Model.Value = Value;
    Model.UserID = UserID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * 更新字段值 UserPayMoney
 * @param Key  主键值 Key:UserID
 * @param Value UserPayMoney的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_UserPayMoney = function ( UserID , Value , CallBack ) {
    var Sql = "Update UserMoney Set UserPayMoney=?UserPayMoney where UserID=?UserID";
    var Model = {};
    Model.Value = Value;
    Model.UserID = UserID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * 更新字段值 arrears
 * @param Key  主键值 Key:UserID
 * @param Value arrears的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_arrears = function ( UserID , Value , CallBack ) {
    var Sql = "Update UserMoney Set arrears=?arrears where UserID=?UserID";
    var Model = {};
    Model.Value = Value;
    Model.UserID = UserID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * 更新字段值 Integral
 * @param Key  主键值 Key:UserID
 * @param Value Integral的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_Integral = function ( UserID , Value , CallBack ) {
    var Sql = "Update UserMoney Set Integral=?Integral where UserID=?UserID";
    var Model = {};
    Model.Value = Value;
    Model.UserID = UserID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * 更新字段值 TaskMoney
 * @param Key  主键值 Key:UserID
 * @param Value TaskMoney的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_TaskMoney = function ( UserID , Value , CallBack ) {
    var Sql = "Update UserMoney Set TaskMoney=?TaskMoney where UserID=?UserID";
    var Model = {};
    Model.Value = Value;
    Model.UserID = UserID;
    client.Query ( Sql , Model , function ( err , Result ) {
...
exports.Delete=function(UserID,CallBack){
    var Sql = "Delete From UserMoney Where UserID=?UserID";
    var Model={};
    Model.UserID=UserID;
    client.Query ( Sql , Model , function ( err , Result ) {
        CallBack ( err , Result );
...
var DeleteByFilter=function(Filter,CallBack){
    var Sql = "Delete From UserMoney where "+Filter+"";
    client.Query ( Sql  , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports. DeleteByFilter=function(){
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/UserMoney.js=>DeleteByFilter 缺少参数");
    CallBack(false,null);
}
...
var GetPageRow = function ( CurPage , PageSize , Filter , CallBack ) {
    ...
    var Sql = "Select *  from UserMoney  where " + Filter + "  limit " + (PageSize * (CurPage - 1)) + "," + PageSize + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var GetPageRow_Field = function ( Field , CurPage , PageSize , Filter , CallBack ) {
    if(Filter=="")  Filter="1=1";
    var Sql = "Select " + Field + "  from UserMoney  where " + Filter + "  limit " + (PageSize * (CurPage - 1)) + "," + PageSize + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports.GetPageRow=function(){
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/UserMoney.js=>GetPageRow 缺少参数");
    CallBack(false,null);
}
