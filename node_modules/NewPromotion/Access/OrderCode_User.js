...
var GetRsCount=function(Filter,CallBack){
    var Sql = "Select Count(*) as Count From OrderCode_User Where " + Filter + "";
...
exports.GetRsCount = function () {
    ...
    console.log("Access/OrderCode_User.js=>GetRsCount 缺少参数");
    CallBack(false,null);
}
/*-----统计求和--------------*/
var Sum=function(Field,Filter,CallBack){
    var Sql = "Select Sum("+Field+") as SumCount From OrderCode_User Where "+Filter+"";
    client.Query ( Sql , function ( err , Result ) {
...
exports.Sum = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/OrderCode_User.js=>Sum 缺少参数");
    CallBack(false,null);
}

/*-----查询所有记录--------------*/
var SelectAll = function ( CallBack ) {
    var Sql = "Select * From OrderCode_User";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var SelectAll_Field = function (Field, CallBack ) {
    var Sql = "Select "+Field+" From OrderCode_User";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var SelectAllByOrder = function (Field ,  Order , CallBack ) {
    var Sql = "Select "+Field+" From OrderCode_User  Order By " + Order;
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports.SelectAll = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/OrderCode_User.js=>SelectAll 缺少参数");
    CallBack(false,null);
}
/*-----根据关键字查询记录--------------*/

var Select = function ( ID , CallBack ) {
    var Sql = "Select * From OrderCode_User Where ID=?ID";
    var Values = {};
    Values.ID = ID;
    client.Query ( Sql , Values , function ( err , Result ) {
        if ( Result.length > 0 ) {
    ...
    var Sql = "Select "+Field+" From OrderCode_User Where ID=?ID";
    var Values = {};
    Values.ID = ID;
    client.Query ( Sql , Values , function ( err , Result ) {
        if ( Result.length > 0 ) {
...
exports.Select = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/OrderCode_User.js=>Select 缺少参数");
    CallBack(false,null);
}

/*-----根据条件查询记录--------------*/
var SelectByFilter = function ( Filter , CallBack ) {
    var Sql = "Select * From OrderCode_User Where " + Filter + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var SelectByFilter_Field = function (Field, Filter , CallBack ) {
    var Sql = "Select "+Field+" From OrderCode_User Where " + Filter + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports.SelectByFilter = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/OrderCode_User.js=>SelectByFilter 缺少参数");
    CallBack(false,null);
}
...
exports.Insert = function ( Model , CallBack ) {
    var Sql = "Insert Into OrderCode_User Set ID=?ID,_OrderCodeID=?_OrderCodeID,_UserID=?_UserID,UserType=?UserType,FanliJS=?FanliJS,IsSettlement=?IsSettlement ";
...
exports.Update = function ( Model , CallBack ) {
    var Sql = "Update OrderCode_User Set  ID=?ID,_OrderCodeID=?_OrderCodeID,_UserID=?_UserID,UserType=?UserType,FanliJS=?FanliJS,IsSettlement=?IsSettlement Where ID=?ID";
    client.Query ( Sql , Model , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports.Set_ID = function ( ID , Value , CallBack ) {
    var Sql = "Update OrderCode_User Set ID=?ID where ID=?ID";
    var Model = {};
    Model.Value = Value;
    Model.ID = ID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * 更新字段值 _OrderCodeID
 * @param Key  主键值 Key:ID
 * @param Value _OrderCodeID的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set__OrderCodeID = function ( ID , Value , CallBack ) {
    var Sql = "Update OrderCode_User Set _OrderCodeID=?_OrderCodeID where ID=?ID";
    var Model = {};
    Model.Value = Value;
    Model.ID = ID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * 更新字段值 _UserID
 * @param Key  主键值 Key:ID
 * @param Value _UserID的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set__UserID = function ( ID , Value , CallBack ) {
    var Sql = "Update OrderCode_User Set _UserID=?_UserID where ID=?ID";
    var Model = {};
    Model.Value = Value;
    Model.ID = ID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * 更新字段值 UserType
 * @param Key  主键值 Key:ID
 * @param Value UserType的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_UserType = function ( ID , Value , CallBack ) {
    var Sql = "Update OrderCode_User Set UserType=?UserType where ID=?ID";
    var Model = {};
    Model.Value = Value;
    Model.ID = ID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * 更新字段值 FanliJS
 * @param Key  主键值 Key:ID
 * @param Value FanliJS的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_FanliJS = function ( ID , Value , CallBack ) {
    var Sql = "Update OrderCode_User Set FanliJS=?FanliJS where ID=?ID";
    var Model = {};
    Model.Value = Value;
    Model.ID = ID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * 更新字段值 IsSettlement
 * @param Key  主键值 Key:ID
 * @param Value IsSettlement的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_IsSettlement = function ( ID , Value , CallBack ) {
    var Sql = "Update OrderCode_User Set IsSettlement=?IsSettlement where ID=?ID";
    var Model = {};
    Model.Value = Value;
    Model.ID = ID;
    client.Query ( Sql , Model , function ( err , Result ) {
...
exports.Delete=function(ID,CallBack){
    var Sql = "Delete From OrderCode_User Where ID=?ID";
    var Model={};
    Model.ID=ID;
    client.Query ( Sql , Model , function ( err , Result ) {
        CallBack ( err , Result );
...
exports.DeleteAll=function(CallBack){
    var Sql = "Delete From OrderCode_User";
    client.Query ( Sql  , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var DeleteByFilter=function(Filter,CallBack){
    var Sql = "Delete From OrderCode_User where "+Filter+"";
    client.Query ( Sql  , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports. DeleteByFilter=function(){
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/OrderCode_User.js=>DeleteByFilter 缺少参数");
    CallBack(false,null);
}
...
var GetPageRow = function ( CurPage , PageSize , Filter , CallBack ) {
    ...
    var Sql = "Select *  from OrderCode_User  where " + Filter + "  limit " + (PageSize * (CurPage - 1)) + "," + PageSize + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var GetPageRow_Field = function ( Field , CurPage , PageSize , Filter , CallBack ) {
    if(Filter=="")  Filter="1=1";
    var Sql = "Select " + Field + "  from OrderCode_User  where " + Filter + "  limit " + (PageSize * (CurPage - 1)) + "," + PageSize + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports.GetPageRow=function(){
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/OrderCode_User.js=>GetPageRow 缺少参数");
    CallBack(false,null);
}
