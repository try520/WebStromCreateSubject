...
var GetRsCount=function(Filter,CallBack){
    var Sql = "Select Count(*) as Count From SiteTrade Where " + Filter + "";
...
exports.GetRsCount = function () {
    ...
    console.log("Access/SiteTrade.js=>GetRsCount 缺少参数");
    CallBack(false,null);
}
/*-----统计求和--------------*/
var Sum=function(Field,Filter,CallBack){
    var Sql = "Select Sum("+Field+") as SumCount From SiteTrade Where "+Filter+"";
    client.Query ( Sql , function ( err , Result ) {
...
exports.Sum = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/SiteTrade.js=>Sum 缺少参数");
    CallBack(false,null);
}

/*-----查询所有记录--------------*/
var SelectAll = function ( CallBack ) {
    var Sql = "Select * From SiteTrade";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var SelectAll_Field = function (Field, CallBack ) {
    var Sql = "Select "+Field+" From SiteTrade";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var SelectAllByOrder = function (Field ,  Order , CallBack ) {
    var Sql = "Select "+Field+" From SiteTrade  Order By " + Order;
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports.SelectAll = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/SiteTrade.js=>SelectAll 缺少参数");
    CallBack(false,null);
}
/*-----根据关键字查询记录--------------*/

var Select = function ( TradeID , CallBack ) {
    var Sql = "Select * From SiteTrade Where TradeID=?TradeID";
    var Values = {};
    ...
    var Select_Field = function (Field, TradeID , CallBack ) {
    var Sql = "Select "+Field+" From SiteTrade Where TradeID=?TradeID";
    var Values = {};
    Values.TradeID = TradeID;
    client.Query ( Sql , Values , function ( err , Result ) {
        if ( Result.length > 0 ) {
...
exports.Select = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/SiteTrade.js=>Select 缺少参数");
    CallBack(false,null);
}

/*-----根据条件查询记录--------------*/
var SelectByFilter = function ( Filter , CallBack ) {
    var Sql = "Select * From SiteTrade Where " + Filter + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var SelectByFilter_Field = function (Field, Filter , CallBack ) {
    var Sql = "Select "+Field+" From SiteTrade Where " + Filter + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports.SelectByFilter = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/SiteTrade.js=>SelectByFilter 缺少参数");
    CallBack(false,null);
}
...
exports.Insert = function ( Model , CallBack ) {
    var Sql = "Insert Into SiteTrade Set TradeID=?TradeID,TradeType=?TradeType,ShopID=?ShopID,real_pay_fee=?real_pay_fee,commission_rate=?commission_rate,commission=?commission,create_time=?create_time,pay_time=?pay_time,pay_price=?pay_price,num_iid=?num_iid,item_title=?item_title,item_num=?item_num,seller_nick=?seller_nick,outer_code=?outer_code,ShopName=?ShopName,TradeStatus=?TradeStatus ";
...
exports.Update = function ( Model , CallBack ) {
    var Sql = "Update SiteTrade Set  TradeID=?TradeID,TradeType=?TradeType,ShopID=?ShopID,real_pay_fee=?real_pay_fee,commission_rate=?commission_rate,commission=?commission,create_time=?create_time,pay_time=?pay_time,pay_price=?pay_price,num_iid=?num_iid,item_title=?item_title,item_num=?item_num,seller_nick=?seller_nick,outer_code=?outer_code,ShopName=?ShopName,TradeStatus=?TradeStatus Where TradeID=?TradeID";
    client.Query ( Sql , Model , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
/**
 * 更新字段值 TradeID
 * @param Key  主键值 Key:TradeID
 * @param Value TradeID的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_TradeID = function ( TradeID , Value , CallBack ) {
    var Sql = "Update SiteTrade Set TradeID=?TradeID where TradeID=?TradeID";
    var Model = {};
    Model.Value = Value;
 ...
 * 更新字段值 TradeType
 * @param Key  主键值 Key:TradeID
 * @param Value TradeType的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_TradeType = function ( TradeID , Value , CallBack ) {
    var Sql = "Update SiteTrade Set TradeType=?TradeType where TradeID=?TradeID";
    var Model = {};
    Model.Value = Value;
    Model.TradeID = TradeID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * @constructor
 */
exports.Set_ShopID = function ( TradeID , Value , CallBack ) {
    var Sql = "Update SiteTrade Set ShopID=?ShopID where TradeID=?TradeID";
    var Model = {};
    Model.Value = Value;
    Model.TradeID = TradeID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * 更新字段值 real_pay_fee
 * @param Key  主键值 Key:TradeID
 * @param Value real_pay_fee的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_real_pay_fee = function ( TradeID , Value , CallBack ) {
    var Sql = "Update SiteTrade Set real_pay_fee=?real_pay_fee where TradeID=?TradeID";
    var Model = {};
    Model.Value = Value;
    Model.TradeID = TradeID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * @constructor
 */
exports.Set_commission_rate = function ( TradeID , Value , CallBack ) {
    var Sql = "Update SiteTrade Set commission_rate=?commission_rate where TradeID=?TradeID";
    var Model = {};
    Model.Value = Value;
    Model.TradeID = TradeID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * 更新字段值 commission
 * @param Key  主键值 Key:TradeID
 * @param Value commission的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_commission = function ( TradeID , Value , CallBack ) {
    var Sql = "Update SiteTrade Set commission=?commission where TradeID=?TradeID";
    var Model = {};
    Model.Value = Value;
    Model.TradeID = TradeID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * 更新字段值 create_time
 * @param Key  主键值 Key:TradeID
 * @param Value create_time的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_create_time = function ( TradeID , Value , CallBack ) {
    var Sql = "Update SiteTrade Set create_time=?create_time where TradeID=?TradeID";
    var Model = {};
    Model.Value = Value;
    Model.TradeID = TradeID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * 更新字段值 pay_time
 * @param Key  主键值 Key:TradeID
 * @param Value pay_time的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_pay_time = function ( TradeID , Value , CallBack ) {
    var Sql = "Update SiteTrade Set pay_time=?pay_time where TradeID=?TradeID";
    var Model = {};
    Model.Value = Value;
    Model.TradeID = TradeID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * 更新字段值 pay_price
 * @param Key  主键值 Key:TradeID
 * @param Value pay_price的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_pay_price = function ( TradeID , Value , CallBack ) {
    var Sql = "Update SiteTrade Set pay_price=?pay_price where TradeID=?TradeID";
    var Model = {};
    Model.Value = Value;
    Model.TradeID = TradeID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * 更新字段值 num_iid
 * @param Key  主键值 Key:TradeID
 * @param Value num_iid的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_num_iid = function ( TradeID , Value , CallBack ) {
    var Sql = "Update SiteTrade Set num_iid=?num_iid where TradeID=?TradeID";
    var Model = {};
    Model.Value = Value;
    Model.TradeID = TradeID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * 更新字段值 item_title
 * @param Key  主键值 Key:TradeID
 * @param Value item_title的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_item_title = function ( TradeID , Value , CallBack ) {
    var Sql = "Update SiteTrade Set item_title=?item_title where TradeID=?TradeID";
    var Model = {};
    Model.Value = Value;
    Model.TradeID = TradeID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * 更新字段值 item_num
 * @param Key  主键值 Key:TradeID
 * @param Value item_num的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_item_num = function ( TradeID , Value , CallBack ) {
    var Sql = "Update SiteTrade Set item_num=?item_num where TradeID=?TradeID";
    var Model = {};
    Model.Value = Value;
    Model.TradeID = TradeID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * 更新字段值 seller_nick
 * @param Key  主键值 Key:TradeID
 * @param Value seller_nick的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_seller_nick = function ( TradeID , Value , CallBack ) {
    var Sql = "Update SiteTrade Set seller_nick=?seller_nick where TradeID=?TradeID";
    var Model = {};
    Model.Value = Value;
    Model.TradeID = TradeID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * 更新字段值 outer_code
 * @param Key  主键值 Key:TradeID
 * @param Value outer_code的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_outer_code = function ( TradeID , Value , CallBack ) {
    var Sql = "Update SiteTrade Set outer_code=?outer_code where TradeID=?TradeID";
    var Model = {};
    Model.Value = Value;
    Model.TradeID = TradeID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * @constructor
 */
exports.Set_ShopName = function ( TradeID , Value , CallBack ) {
    var Sql = "Update SiteTrade Set ShopName=?ShopName where TradeID=?TradeID";
    var Model = {};
    Model.Value = Value;
    Model.TradeID = TradeID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * 更新字段值 TradeStatus
 * @param Key  主键值 Key:TradeID
 * @param Value TradeStatus的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_TradeStatus = function ( TradeID , Value , CallBack ) {
    var Sql = "Update SiteTrade Set TradeStatus=?TradeStatus where TradeID=?TradeID";
    var Model = {};
    Model.Value = Value;
    Model.TradeID = TradeID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * @constructor
 */
exports.Delete=function(TradeID,CallBack){
    var Sql = "Delete From SiteTrade Where TradeID=?TradeID";
    var Model={};
    Model.TradeID=TradeID;
    client.Query ( Sql , Model , function ( err , Result ) {
        CallBack ( err , Result );
...
var DeleteByFilter=function(Filter,CallBack){
    var Sql = "Delete From SiteTrade where "+Filter+"";
    client.Query ( Sql  , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports. DeleteByFilter=function(){
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/SiteTrade.js=>DeleteByFilter 缺少参数");
    CallBack(false,null);
}
...
var GetPageRow = function ( CurPage , PageSize , Filter , CallBack ) {
    ...
    var Sql = "Select *  from SiteTrade  where " + Filter + "  limit " + (PageSize * (CurPage - 1)) + "," + PageSize + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var GetPageRow_Field = function ( Field , CurPage , PageSize , Filter , CallBack ) {
    if(Filter=="")  Filter="1=1";
    var Sql = "Select " + Field + "  from SiteTrade  where " + Filter + "  limit " + (PageSize * (CurPage - 1)) + "," + PageSize + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports.GetPageRow=function(){
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/SiteTrade.js=>GetPageRow 缺少参数");
    CallBack(false,null);
}
