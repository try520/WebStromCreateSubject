...
var GetRsCount=function(Filter,CallBack){
    var Sql = "Select Count(*) as Count From Authority Where " + Filter + "";
...
exports.GetRsCount = function () {
    ...
    console.log("Access/Authority.js=>GetRsCount 缺少参数");
    CallBack(false,null);
}
/*-----统计求和--------------*/
var Sum=function(Field,Filter,CallBack){
    var Sql = "Select Sum("+Field+") as SumCount From Authority Where "+Filter+"";
    client.Query ( Sql , function ( err , Result ) {
...
exports.Sum = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/Authority.js=>Sum 缺少参数");
    CallBack(false,null);
}
...
var SelectAll_Field = function (Field, CallBack ) {
    var Sql = "Select "+Field+" From Authority";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var SelectAllByOrder = function (Field ,  Order , CallBack ) {
    var Sql = "Select "+Field+" From Authority  Order By " + Order;
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports.SelectAll = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/Authority.js=>SelectAll 缺少参数");
    CallBack(false,null);
}
/*-----根据关键字查询记录--------------*/

var Select = function ( AuthorityID , CallBack ) {
    var Sql = "Select * From Authority Where AuthorityID=?AuthorityID";
    var Values = {};
    Values.AuthorityID = AuthorityID;
    client.Query ( Sql , Values , function ( err , Result ) {
        if ( Result.length > 0 ) {
    ...
    var Select_Field = function (Field, AuthorityID , CallBack ) {
    var Sql = "Select "+Field+" From Authority Where AuthorityID=?AuthorityID";
    var Values = {};
    Values.AuthorityID = AuthorityID;
    client.Query ( Sql , Values , function ( err , Result ) {
        if ( Result.length > 0 ) {
...
exports.Select = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/Authority.js=>Select 缺少参数");
    CallBack(false,null);
}

/*-----根据条件查询记录--------------*/
var SelectByFilter = function ( Filter , CallBack ) {
    var Sql = "Select * From Authority Where " + Filter + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var SelectByFilter_Field = function (Field, Filter , CallBack ) {
    var Sql = "Select "+Field+" From Authority Where " + Filter + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports.SelectByFilter = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/Authority.js=>SelectByFilter 缺少参数");
    CallBack(false,null);
}
...
exports.Insert = function ( Model , CallBack ) {
    var Sql = "Insert Into Authority Set Name=?Name,URL=?URL,ParentID=?ParentID,Sort=?Sort,IsParent=?IsParent,Able=?Able ";
...
exports.Update = function ( Model , CallBack ) {
    var Sql = "Update Authority Set  Name=?Name,URL=?URL,ParentID=?ParentID,Sort=?Sort,IsParent=?IsParent,Able=?Able Where AuthorityID=?AuthorityID";
    client.Query ( Sql , Model , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
/**
 * 更新字段值 Name
 * @param Key  主键值 Key:AuthorityID
 * @param Value Name的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_Name = function ( AuthorityID , Value , CallBack ) {
    var Sql = "Update Authority Set Name=?Name where AuthorityID=?AuthorityID";
    var Model = {};
    Model.Value = Value;
 ...
 * @constructor
 */
exports.Set_URL = function ( AuthorityID , Value , CallBack ) {
    var Sql = "Update Authority Set URL=?URL where AuthorityID=?AuthorityID";
    var Model = {};
    Model.Value = Value;
    Model.AuthorityID = AuthorityID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * 更新字段值 ParentID
 * @param Key  主键值 Key:AuthorityID
 * @param Value ParentID的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_ParentID = function ( AuthorityID , Value , CallBack ) {
    var Sql = "Update Authority Set ParentID=?ParentID where AuthorityID=?AuthorityID";
    var Model = {};
    Model.Value = Value;
    Model.AuthorityID = AuthorityID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * @constructor
 */
exports.Set_Sort = function ( AuthorityID , Value , CallBack ) {
    var Sql = "Update Authority Set Sort=?Sort where AuthorityID=?AuthorityID";
    var Model = {};
    Model.Value = Value;
    Model.AuthorityID = AuthorityID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * @constructor
 */
exports.Set_IsParent = function ( AuthorityID , Value , CallBack ) {
    var Sql = "Update Authority Set IsParent=?IsParent where AuthorityID=?AuthorityID";
    var Model = {};
    Model.Value = Value;
    Model.AuthorityID = AuthorityID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * @constructor
 */
exports.Set_Able = function ( AuthorityID , Value , CallBack ) {
    var Sql = "Update Authority Set Able=?Able where AuthorityID=?AuthorityID";
    var Model = {};
    Model.Value = Value;
    Model.AuthorityID = AuthorityID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * @constructor
 */
exports.Delete=function(AuthorityID,CallBack){
    var Sql = "Delete From Authority Where AuthorityID=?AuthorityID";
    var Model={};
    Model.AuthorityID=AuthorityID;
    client.Query ( Sql , Model , function ( err , Result ) {
        CallBack ( err , Result );
...
var DeleteByFilter=function(Filter,CallBack){
    var Sql = "Delete From Authority where "+Filter+"";
    client.Query ( Sql  , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports. DeleteByFilter=function(){
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/Authority.js=>DeleteByFilter 缺少参数");
    CallBack(false,null);
}
...
var GetPageRow = function ( CurPage , PageSize , Filter , CallBack ) {
    ...
    var Sql = "Select *  from Authority  where " + Filter + "  limit " + (PageSize * (CurPage - 1)) + "," + PageSize + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var GetPageRow_Field = function ( Field , CurPage , PageSize , Filter , CallBack ) {
    if(Filter=="")  Filter="1=1";
    var Sql = "Select " + Field + "  from Authority  where " + Filter + "  limit " + (PageSize * (CurPage - 1)) + "," + PageSize + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports.GetPageRow=function(){
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/Authority.js=>GetPageRow 缺少参数");
    CallBack(false,null);
}
