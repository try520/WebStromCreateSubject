...
var GetRsCount=function(Filter,CallBack){
    var Sql = "Select Count(*) as Count From SiteLabel Where " + Filter + "";
...
exports.GetRsCount = function () {
    ...
    console.log("Access/SiteLabel.js=>GetRsCount 缺少参数");
    CallBack(false,null);
}
/*-----统计求和--------------*/
var Sum=function(Field,Filter,CallBack){
    var Sql = "Select Sum("+Field+") as SumCount From SiteLabel Where "+Filter+"";
    client.Query ( Sql , function ( err , Result ) {
...
exports.Sum = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/SiteLabel.js=>Sum 缺少参数");
    CallBack(false,null);
}

/*-----查询所有记录--------------*/
var SelectAll = function ( CallBack ) {
    var Sql = "Select * From SiteLabel";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var SelectAll_Field = function (Field, CallBack ) {
    var Sql = "Select "+Field+" From SiteLabel";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var SelectAllByOrder = function (Field ,  Order , CallBack ) {
    var Sql = "Select "+Field+" From SiteLabel  Order By " + Order;
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports.SelectAll = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/SiteLabel.js=>SelectAll 缺少参数");
    CallBack(false,null);
}
/*-----根据关键字查询记录--------------*/

var Select = function ( LabelID , CallBack ) {
    var Sql = "Select * From SiteLabel Where LabelID=?LabelID";
    var Values = {};
    ...
    var Select_Field = function (Field, LabelID , CallBack ) {
    var Sql = "Select "+Field+" From SiteLabel Where LabelID=?LabelID";
    var Values = {};
    Values.LabelID = LabelID;
    client.Query ( Sql , Values , function ( err , Result ) {
        if ( Result.length > 0 ) {
...
exports.Select = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/SiteLabel.js=>Select 缺少参数");
    CallBack(false,null);
}

/*-----根据条件查询记录--------------*/
var SelectByFilter = function ( Filter , CallBack ) {
    var Sql = "Select * From SiteLabel Where " + Filter + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var SelectByFilter_Field = function (Field, Filter , CallBack ) {
    var Sql = "Select "+Field+" From SiteLabel Where " + Filter + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports.SelectByFilter = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/SiteLabel.js=>SelectByFilter 缺少参数");
    CallBack(false,null);
}
...
exports.Insert = function ( Model , CallBack ) {
    var Sql = "Insert Into SiteLabel Set LabelName=?LabelName,LabelParentID=?LabelParentID,LabelLogo=?LabelLogo,IsParent=?IsParent,LabelProdCount=?LabelProdCount,Sort=?Sort,KeyWordLabel=?KeyWordLabel ";
...
exports.Update = function ( Model , CallBack ) {
    var Sql = "Update SiteLabel Set  LabelName=?LabelName,LabelParentID=?LabelParentID,LabelLogo=?LabelLogo,IsParent=?IsParent,LabelProdCount=?LabelProdCount,Sort=?Sort,KeyWordLabel=?KeyWordLabel Where LabelID=?LabelID";
    client.Query ( Sql , Model , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
/**
 * 更新字段值 LabelName
 * @param Key  主键值 Key:LabelID
 * @param Value LabelName的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_LabelName = function ( LabelID , Value , CallBack ) {
    var Sql = "Update SiteLabel Set LabelName=?LabelName where LabelID=?LabelID";
    var Model = {};
    Model.Value = Value;
 ...
 * 更新字段值 LabelParentID
 * @param Key  主键值 Key:LabelID
 * @param Value LabelParentID的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_LabelParentID = function ( LabelID , Value , CallBack ) {
    var Sql = "Update SiteLabel Set LabelParentID=?LabelParentID where LabelID=?LabelID";
    var Model = {};
    Model.Value = Value;
    Model.LabelID = LabelID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * 更新字段值 LabelLogo
 * @param Key  主键值 Key:LabelID
 * @param Value LabelLogo的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_LabelLogo = function ( LabelID , Value , CallBack ) {
    var Sql = "Update SiteLabel Set LabelLogo=?LabelLogo where LabelID=?LabelID";
    var Model = {};
    Model.Value = Value;
    Model.LabelID = LabelID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * 更新字段值 IsParent
 * @param Key  主键值 Key:LabelID
 * @param Value IsParent的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_IsParent = function ( LabelID , Value , CallBack ) {
    var Sql = "Update SiteLabel Set IsParent=?IsParent where LabelID=?LabelID";
    var Model = {};
    Model.Value = Value;
    Model.LabelID = LabelID;
    client.Query ( Sql , Model , function ( err , Result ) {
...
/**
 * 更新字段值 LabelProdCount
 * @param Key  主键值 Key:LabelID
 * @param Value LabelProdCount的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_LabelProdCount = function ( LabelID , Value , CallBack ) {
    var Sql = "Update SiteLabel Set LabelProdCount=?LabelProdCount where LabelID=?LabelID";
    var Model = {};
    Model.Value = Value;
    Model.LabelID = LabelID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * @constructor
 */
exports.Set_Sort = function ( LabelID , Value , CallBack ) {
    var Sql = "Update SiteLabel Set Sort=?Sort where LabelID=?LabelID";
    var Model = {};
    Model.Value = Value;
    Model.LabelID = LabelID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * 更新字段值 KeyWordLabel
 * @param Key  主键值 Key:LabelID
 * @param Value KeyWordLabel的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_KeyWordLabel = function ( LabelID , Value , CallBack ) {
    var Sql = "Update SiteLabel Set KeyWordLabel=?KeyWordLabel where LabelID=?LabelID";
    var Model = {};
    Model.Value = Value;
    Model.LabelID = LabelID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * @constructor
 */
exports.Delete=function(LabelID,CallBack){
    var Sql = "Delete From SiteLabel Where LabelID=?LabelID";
    var Model={};
    Model.LabelID=LabelID;
    client.Query ( Sql , Model , function ( err , Result ) {
        CallBack ( err , Result );
...
var DeleteByFilter=function(Filter,CallBack){
    var Sql = "Delete From SiteLabel where "+Filter+"";
    client.Query ( Sql  , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports. DeleteByFilter=function(){
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/SiteLabel.js=>DeleteByFilter 缺少参数");
    CallBack(false,null);
}
...
var GetPageRow = function ( CurPage , PageSize , Filter , CallBack ) {
    ...
    var Sql = "Select *  from SiteLabel  where " + Filter + "  limit " + (PageSize * (CurPage - 1)) + "," + PageSize + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var GetPageRow_Field = function ( Field , CurPage , PageSize , Filter , CallBack ) {
    if(Filter=="")  Filter="1=1";
    var Sql = "Select " + Field + "  from SiteLabel  where " + Filter + "  limit " + (PageSize * (CurPage - 1)) + "," + PageSize + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports.GetPageRow=function(){
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/SiteLabel.js=>GetPageRow 缺少参数");
    CallBack(false,null);
}
