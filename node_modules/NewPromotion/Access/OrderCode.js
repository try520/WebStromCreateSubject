...
var GetRsCount=function(Filter,CallBack){
    var Sql = "Select Count(*) as Count From OrderCode Where " + Filter + "";
...
exports.GetRsCount = function () {
    ...
    console.log("Access/OrderCode.js=>GetRsCount 缺少参数");
    CallBack(false,null);
}
/*-----统计求和--------------*/
var Sum=function(Field,Filter,CallBack){
    var Sql = "Select Sum("+Field+") as SumCount From OrderCode Where "+Filter+"";
    client.Query ( Sql , function ( err , Result ) {
...
exports.Sum = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/OrderCode.js=>Sum 缺少参数");
    CallBack(false,null);
}

/*-----查询所有记录--------------*/
var SelectAll = function ( CallBack ) {
    var Sql = "Select * From OrderCode";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var SelectAll_Field = function (Field, CallBack ) {
    var Sql = "Select "+Field+" From OrderCode";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var SelectAllByOrder = function (Field ,  Order , CallBack ) {
    var Sql = "Select "+Field+" From OrderCode  Order By " + Order;
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports.SelectAll = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/OrderCode.js=>SelectAll 缺少参数");
    CallBack(false,null);
}
/*-----根据关键字查询记录--------------*/

var Select = function ( OrderCodeID , CallBack ) {
    var Sql = "Select * From OrderCode Where OrderCodeID=?OrderCodeID";
    var Values = {};
    Values.OrderCodeID = OrderCodeID;
    client.Query ( Sql , Values , function ( err , Result ) {
        if ( Result.length > 0 ) {
    ...
    var Select_Field = function (Field, OrderCodeID , CallBack ) {
    var Sql = "Select "+Field+" From OrderCode Where OrderCodeID=?OrderCodeID";
    var Values = {};
    Values.OrderCodeID = OrderCodeID;
    client.Query ( Sql , Values , function ( err , Result ) {
        if ( Result.length > 0 ) {
...
exports.Select = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/OrderCode.js=>Select 缺少参数");
    CallBack(false,null);
}

/*-----根据条件查询记录--------------*/
var SelectByFilter = function ( Filter , CallBack ) {
    var Sql = "Select * From OrderCode Where " + Filter + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var SelectByFilter_Field = function (Field, Filter , CallBack ) {
    var Sql = "Select "+Field+" From OrderCode Where " + Filter + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports.SelectByFilter = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/OrderCode.js=>SelectByFilter 缺少参数");
    CallBack(false,null);
}
...
exports.Insert = function ( Model , CallBack ) {
    var Sql = "Insert Into OrderCode Set OrderCodeID=?OrderCodeID,Tag=?Tag,CodeType=?CodeType,CreateTime=?CreateTime,SettlementTime=?SettlementTime ";
...
exports.Update = function ( Model , CallBack ) {
    var Sql = "Update OrderCode Set  OrderCodeID=?OrderCodeID,Tag=?Tag,CodeType=?CodeType,CreateTime=?CreateTime,SettlementTime=?SettlementTime Where OrderCodeID=?OrderCodeID";
    client.Query ( Sql , Model , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
/**
 * 更新字段值 OrderCodeID
 * @param Key  主键值 Key:OrderCodeID
 * @param Value OrderCodeID的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_OrderCodeID = function ( OrderCodeID , Value , CallBack ) {
    var Sql = "Update OrderCode Set OrderCodeID=?OrderCodeID where OrderCodeID=?OrderCodeID";
    var Model = {};
    Model.Value = Value;
    Model.OrderCodeID = OrderCodeID;
    client.Query ( Sql , Model , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
 ...
 * @constructor
 */
exports.Set_Tag = function ( OrderCodeID , Value , CallBack ) {
    var Sql = "Update OrderCode Set Tag=?Tag where OrderCodeID=?OrderCodeID";
    var Model = {};
    Model.Value = Value;
    Model.OrderCodeID = OrderCodeID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * 更新字段值 CodeType
 * @param Key  主键值 Key:OrderCodeID
 * @param Value CodeType的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_CodeType = function ( OrderCodeID , Value , CallBack ) {
    var Sql = "Update OrderCode Set CodeType=?CodeType where OrderCodeID=?OrderCodeID";
    var Model = {};
    Model.Value = Value;
    Model.OrderCodeID = OrderCodeID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * @constructor
 */
exports.Set_CreateTime = function ( OrderCodeID , Value , CallBack ) {
    var Sql = "Update OrderCode Set CreateTime=?CreateTime where OrderCodeID=?OrderCodeID";
    var Model = {};
    Model.Value = Value;
    Model.OrderCodeID = OrderCodeID;
    client.Query ( Sql , Model , function ( err , Result ) {
...
/**
 * 更新字段值 SettlementTime
 * @param Key  主键值 Key:OrderCodeID
 * @param Value SettlementTime的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_SettlementTime = function ( OrderCodeID , Value , CallBack ) {
    var Sql = "Update OrderCode Set SettlementTime=?SettlementTime where OrderCodeID=?OrderCodeID";
    var Model = {};
    Model.Value = Value;
    Model.OrderCodeID = OrderCodeID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * @constructor
 */
exports.Delete=function(OrderCodeID,CallBack){
    var Sql = "Delete From OrderCode Where OrderCodeID=?OrderCodeID";
    var Model={};
    Model.OrderCodeID=OrderCodeID;
    client.Query ( Sql , Model , function ( err , Result ) {
        CallBack ( err , Result );
...
var DeleteByFilter=function(Filter,CallBack){
    var Sql = "Delete From OrderCode where "+Filter+"";
    client.Query ( Sql  , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports. DeleteByFilter=function(){
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/OrderCode.js=>DeleteByFilter 缺少参数");
    CallBack(false,null);
}
...
var GetPageRow = function ( CurPage , PageSize , Filter , CallBack ) {
    ...
    var Sql = "Select *  from OrderCode  where " + Filter + "  limit " + (PageSize * (CurPage - 1)) + "," + PageSize + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var GetPageRow_Field = function ( Field , CurPage , PageSize , Filter , CallBack ) {
    if(Filter=="")  Filter="1=1";
    var Sql = "Select " + Field + "  from OrderCode  where " + Filter + "  limit " + (PageSize * (CurPage - 1)) + "," + PageSize + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports.GetPageRow=function(){
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/OrderCode.js=>GetPageRow 缺少参数");
    CallBack(false,null);
}
