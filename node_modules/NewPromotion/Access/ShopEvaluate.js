...
var GetRsCount=function(Filter,CallBack){
    var Sql = "Select Count(*) as Count From ShopEvaluate Where " + Filter + "";
...
exports.GetRsCount = function () {
    ...
    console.log("Access/ShopEvaluate.js=>GetRsCount 缺少参数");
    CallBack(false,null);
}
/*-----统计求和--------------*/
var Sum=function(Field,Filter,CallBack){
    var Sql = "Select Sum("+Field+") as SumCount From ShopEvaluate Where "+Filter+"";
    client.Query ( Sql , function ( err , Result ) {
...
exports.Sum = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/ShopEvaluate.js=>Sum 缺少参数");
    CallBack(false,null);
}

/*-----查询所有记录--------------*/
var SelectAll = function ( CallBack ) {
    var Sql = "Select * From ShopEvaluate";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var SelectAll_Field = function (Field, CallBack ) {
    var Sql = "Select "+Field+" From ShopEvaluate";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var SelectAllByOrder = function (Field ,  Order , CallBack ) {
    var Sql = "Select "+Field+" From ShopEvaluate  Order By " + Order;
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports.SelectAll = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/ShopEvaluate.js=>SelectAll 缺少参数");
    CallBack(false,null);
}
/*-----根据关键字查询记录--------------*/

var Select = function ( EvalID , CallBack ) {
    var Sql = "Select * From ShopEvaluate Where EvalID=?EvalID";
    var Values = {};
    Values.EvalID = EvalID;
    client.Query ( Sql , Values , function ( err , Result ) {
        if ( Result.length > 0 ) {
    ...
    var Select_Field = function (Field, EvalID , CallBack ) {
    var Sql = "Select "+Field+" From ShopEvaluate Where EvalID=?EvalID";
    var Values = {};
    Values.EvalID = EvalID;
    client.Query ( Sql , Values , function ( err , Result ) {
        if ( Result.length > 0 ) {
...
exports.Select = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/ShopEvaluate.js=>Select 缺少参数");
    CallBack(false,null);
}

/*-----根据条件查询记录--------------*/
var SelectByFilter = function ( Filter , CallBack ) {
    var Sql = "Select * From ShopEvaluate Where " + Filter + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var SelectByFilter_Field = function (Field, Filter , CallBack ) {
    var Sql = "Select "+Field+" From ShopEvaluate Where " + Filter + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports.SelectByFilter = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/ShopEvaluate.js=>SelectByFilter 缺少参数");
    CallBack(false,null);
}
...
exports.Insert = function ( Model , CallBack ) {
    var Sql = "Insert Into ShopEvaluate Set EvalID=?EvalID,Eval_UserID=?Eval_UserID,Eval_UserName=?Eval_UserName,Eval_ShopID=?Eval_ShopID,ShopEvalType=?ShopEvalType,EvalInfo=?EvalInfo,Point=?Point,EvalWtime=?EvalWtime ";
...
exports.Update = function ( Model , CallBack ) {
    var Sql = "Update ShopEvaluate Set  EvalID=?EvalID,Eval_UserID=?Eval_UserID,Eval_UserName=?Eval_UserName,Eval_ShopID=?Eval_ShopID,ShopEvalType=?ShopEvalType,EvalInfo=?EvalInfo,Point=?Point,EvalWtime=?EvalWtime Where EvalID=?EvalID";
    client.Query ( Sql , Model , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
/**
 * 更新字段值 EvalID
 * @param Key  主键值 Key:EvalID
 * @param Value EvalID的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_EvalID = function ( EvalID , Value , CallBack ) {
    var Sql = "Update ShopEvaluate Set EvalID=?EvalID where EvalID=?EvalID";
    var Model = {};
    Model.Value = Value;
    Model.EvalID = EvalID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * 更新字段值 Eval_UserID
 * @param Key  主键值 Key:EvalID
 * @param Value Eval_UserID的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_Eval_UserID = function ( EvalID , Value , CallBack ) {
    var Sql = "Update ShopEvaluate Set Eval_UserID=?Eval_UserID where EvalID=?EvalID";
    var Model = {};
    Model.Value = Value;
    Model.EvalID = EvalID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * 更新字段值 Eval_UserName
 * @param Key  主键值 Key:EvalID
 * @param Value Eval_UserName的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_Eval_UserName = function ( EvalID , Value , CallBack ) {
    var Sql = "Update ShopEvaluate Set Eval_UserName=?Eval_UserName where EvalID=?EvalID";
    var Model = {};
    Model.Value = Value;
    Model.EvalID = EvalID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * 更新字段值 Eval_ShopID
 * @param Key  主键值 Key:EvalID
 * @param Value Eval_ShopID的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_Eval_ShopID = function ( EvalID , Value , CallBack ) {
    var Sql = "Update ShopEvaluate Set Eval_ShopID=?Eval_ShopID where EvalID=?EvalID";
    var Model = {};
    Model.Value = Value;
    Model.EvalID = EvalID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * 更新字段值 ShopEvalType
 * @param Key  主键值 Key:EvalID
 * @param Value ShopEvalType的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_ShopEvalType = function ( EvalID , Value , CallBack ) {
    var Sql = "Update ShopEvaluate Set ShopEvalType=?ShopEvalType where EvalID=?EvalID";
    var Model = {};
    Model.Value = Value;
    Model.EvalID = EvalID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * 更新字段值 EvalInfo
 * @param Key  主键值 Key:EvalID
 * @param Value EvalInfo的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_EvalInfo = function ( EvalID , Value , CallBack ) {
    var Sql = "Update ShopEvaluate Set EvalInfo=?EvalInfo where EvalID=?EvalID";
    var Model = {};
    Model.Value = Value;
    Model.EvalID = EvalID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * @constructor
 */
exports.Set_Point = function ( EvalID , Value , CallBack ) {
    var Sql = "Update ShopEvaluate Set Point=?Point where EvalID=?EvalID";
    var Model = {};
    Model.Value = Value;
    Model.EvalID = EvalID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * 更新字段值 EvalWtime
 * @param Key  主键值 Key:EvalID
 * @param Value EvalWtime的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_EvalWtime = function ( EvalID , Value , CallBack ) {
    var Sql = "Update ShopEvaluate Set EvalWtime=?EvalWtime where EvalID=?EvalID";
    var Model = {};
    Model.Value = Value;
    Model.EvalID = EvalID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * @constructor
 */
exports.Delete=function(EvalID,CallBack){
    var Sql = "Delete From ShopEvaluate Where EvalID=?EvalID";
    var Model={};
    Model.EvalID=EvalID;
    client.Query ( Sql , Model , function ( err , Result ) {
        CallBack ( err , Result );
...
exports.DeleteAll=function(CallBack){
    var Sql = "Delete From ShopEvaluate";
    client.Query ( Sql  , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var DeleteByFilter=function(Filter,CallBack){
    var Sql = "Delete From ShopEvaluate where "+Filter+"";
    client.Query ( Sql  , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports. DeleteByFilter=function(){
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/ShopEvaluate.js=>DeleteByFilter 缺少参数");
    CallBack(false,null);
}
...
var GetPageRow = function ( CurPage , PageSize , Filter , CallBack ) {
    ...
    var Sql = "Select *  from ShopEvaluate  where " + Filter + "  limit " + (PageSize * (CurPage - 1)) + "," + PageSize + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var GetPageRow_Field = function ( Field , CurPage , PageSize , Filter , CallBack ) {
    if(Filter=="")  Filter="1=1";
    var Sql = "Select " + Field + "  from ShopEvaluate  where " + Filter + "  limit " + (PageSize * (CurPage - 1)) + "," + PageSize + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports.GetPageRow=function(){
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/ShopEvaluate.js=>GetPageRow 缺少参数");
    CallBack(false,null);
}
