...
var GetRsCount=function(Filter,CallBack){
    var Sql = "Select Count(*) as Count From ClubGroup Where " + Filter + "";
...
exports.GetRsCount = function () {
    ...
    console.log("Access/ClubGroup.js=>GetRsCount 缺少参数");
    CallBack(false,null);
}
/*-----统计求和--------------*/
var Sum=function(Field,Filter,CallBack){
    var Sql = "Select Sum("+Field+") as SumCount From ClubGroup Where "+Filter+"";
    client.Query ( Sql , function ( err , Result ) {
...
exports.Sum = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/ClubGroup.js=>Sum 缺少参数");
    CallBack(false,null);
}

/*-----查询所有记录--------------*/
var SelectAll = function ( CallBack ) {
    var Sql = "Select * From ClubGroup";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var SelectAll_Field = function (Field, CallBack ) {
    var Sql = "Select "+Field+" From ClubGroup";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var SelectAllByOrder = function (Field ,  Order , CallBack ) {
    var Sql = "Select "+Field+" From ClubGroup  Order By " + Order;
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports.SelectAll = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/ClubGroup.js=>SelectAll 缺少参数");
    CallBack(false,null);
}
/*-----根据关键字查询记录--------------*/

var Select = function ( GroupID , CallBack ) {
    var Sql = "Select * From ClubGroup Where GroupID=?GroupID";
    var Values = {};
    ...
    var Select_Field = function (Field, GroupID , CallBack ) {
    var Sql = "Select "+Field+" From ClubGroup Where GroupID=?GroupID";
    var Values = {};
    Values.GroupID = GroupID;
    client.Query ( Sql , Values , function ( err , Result ) {
        if ( Result.length > 0 ) {
...
exports.Select = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/ClubGroup.js=>Select 缺少参数");
    CallBack(false,null);
}

/*-----根据条件查询记录--------------*/
var SelectByFilter = function ( Filter , CallBack ) {
    var Sql = "Select * From ClubGroup Where " + Filter + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var SelectByFilter_Field = function (Field, Filter , CallBack ) {
    var Sql = "Select "+Field+" From ClubGroup Where " + Filter + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports.SelectByFilter = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/ClubGroup.js=>SelectByFilter 缺少参数");
    CallBack(false,null);
}
...
exports.Insert = function ( Model , CallBack ) {
    var Sql = "Insert Into ClubGroup Set GroupModuleID=?GroupModuleID,GroupName=?GroupName,GroupLogo=?GroupLogo,GroupThreadCount=?GroupThreadCount,GroupUserCount=?GroupUserCount,GroupUpdateTime=?GroupUpdateTime,GroupRule=?GroupRule ";
...
exports.Update = function ( Model , CallBack ) {
    var Sql = "Update ClubGroup Set  GroupModuleID=?GroupModuleID,GroupName=?GroupName,GroupLogo=?GroupLogo,GroupThreadCount=?GroupThreadCount,GroupUserCount=?GroupUserCount,GroupUpdateTime=?GroupUpdateTime,GroupRule=?GroupRule Where GroupID=?GroupID";
    client.Query ( Sql , Model , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
/**
 * 更新字段值 GroupModuleID
 * @param Key  主键值 Key:GroupID
 * @param Value GroupModuleID的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_GroupModuleID = function ( GroupID , Value , CallBack ) {
    var Sql = "Update ClubGroup Set GroupModuleID=?GroupModuleID where GroupID=?GroupID";
    var Model = {};
    Model.Value = Value;
 ...
 * 更新字段值 GroupName
 * @param Key  主键值 Key:GroupID
 * @param Value GroupName的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_GroupName = function ( GroupID , Value , CallBack ) {
    var Sql = "Update ClubGroup Set GroupName=?GroupName where GroupID=?GroupID";
    var Model = {};
    Model.Value = Value;
    Model.GroupID = GroupID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * 更新字段值 GroupLogo
 * @param Key  主键值 Key:GroupID
 * @param Value GroupLogo的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_GroupLogo = function ( GroupID , Value , CallBack ) {
    var Sql = "Update ClubGroup Set GroupLogo=?GroupLogo where GroupID=?GroupID";
    var Model = {};
    Model.Value = Value;
    Model.GroupID = GroupID;
    client.Query ( Sql , Model , function ( err , Result ) {
...
/**
 * 更新字段值 GroupThreadCount
 * @param Key  主键值 Key:GroupID
 * @param Value GroupThreadCount的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_GroupThreadCount = function ( GroupID , Value , CallBack ) {
    var Sql = "Update ClubGroup Set GroupThreadCount=?GroupThreadCount where GroupID=?GroupID";
    var Model = {};
    Model.Value = Value;
    Model.GroupID = GroupID;
    client.Query ( Sql , Model , function ( err , Result ) {
...
/**
 * 更新字段值 GroupUserCount
 * @param Key  主键值 Key:GroupID
 * @param Value GroupUserCount的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_GroupUserCount = function ( GroupID , Value , CallBack ) {
    var Sql = "Update ClubGroup Set GroupUserCount=?GroupUserCount where GroupID=?GroupID";
    var Model = {};
    Model.Value = Value;
    Model.GroupID = GroupID;
    client.Query ( Sql , Model , function ( err , Result ) {
...
/**
 * 更新字段值 GroupUpdateTime
 * @param Key  主键值 Key:GroupID
 * @param Value GroupUpdateTime的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_GroupUpdateTime = function ( GroupID , Value , CallBack ) {
    var Sql = "Update ClubGroup Set GroupUpdateTime=?GroupUpdateTime where GroupID=?GroupID";
    var Model = {};
    Model.Value = Value;
    Model.GroupID = GroupID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * 更新字段值 GroupRule
 * @param Key  主键值 Key:GroupID
 * @param Value GroupRule的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_GroupRule = function ( GroupID , Value , CallBack ) {
    var Sql = "Update ClubGroup Set GroupRule=?GroupRule where GroupID=?GroupID";
    var Model = {};
    Model.Value = Value;
    Model.GroupID = GroupID;
    client.Query ( Sql , Model , function ( err , Result ) {
...
exports.Delete=function(GroupID,CallBack){
    var Sql = "Delete From ClubGroup Where GroupID=?GroupID";
    var Model={};
    Model.GroupID=GroupID;
    client.Query ( Sql , Model , function ( err , Result ) {
        CallBack ( err , Result );
...
var DeleteByFilter=function(Filter,CallBack){
    var Sql = "Delete From ClubGroup where "+Filter+"";
    client.Query ( Sql  , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports. DeleteByFilter=function(){
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/ClubGroup.js=>DeleteByFilter 缺少参数");
    CallBack(false,null);
}
...
var GetPageRow = function ( CurPage , PageSize , Filter , CallBack ) {
    ...
    var Sql = "Select *  from ClubGroup  where " + Filter + "  limit " + (PageSize * (CurPage - 1)) + "," + PageSize + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var GetPageRow_Field = function ( Field , CurPage , PageSize , Filter , CallBack ) {
    if(Filter=="")  Filter="1=1";
    var Sql = "Select " + Field + "  from ClubGroup  where " + Filter + "  limit " + (PageSize * (CurPage - 1)) + "," + PageSize + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports.GetPageRow=function(){
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/ClubGroup.js=>GetPageRow 缺少参数");
    CallBack(false,null);
}
