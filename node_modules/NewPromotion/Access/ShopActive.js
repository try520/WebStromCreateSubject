...
var GetRsCount=function(Filter,CallBack){
    var Sql = "Select Count(*) as Count From ShopActive Where " + Filter + "";
...
exports.GetRsCount = function () {
    ...
    console.log("Access/ShopActive.js=>GetRsCount 缺少参数");
    CallBack(false,null);
}
/*-----统计求和--------------*/
var Sum=function(Field,Filter,CallBack){
    var Sql = "Select Sum("+Field+") as SumCount From ShopActive Where "+Filter+"";
    client.Query ( Sql , function ( err , Result ) {
...
exports.Sum = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/ShopActive.js=>Sum 缺少参数");
    CallBack(false,null);
}

/*-----查询所有记录--------------*/
var SelectAll = function ( CallBack ) {
    var Sql = "Select * From ShopActive";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var SelectAll_Field = function (Field, CallBack ) {
    var Sql = "Select "+Field+" From ShopActive";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var SelectAllByOrder = function (Field ,  Order , CallBack ) {
    var Sql = "Select "+Field+" From ShopActive  Order By " + Order;
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports.SelectAll = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/ShopActive.js=>SelectAll 缺少参数");
    CallBack(false,null);
}
/*-----根据关键字查询记录--------------*/

var Select = function ( ActiveID , CallBack ) {
    var Sql = "Select * From ShopActive Where ActiveID=?ActiveID";
    var Values = {};
    Values.ActiveID = ActiveID;
    client.Query ( Sql , Values , function ( err , Result ) {
        if ( Result.length > 0 ) {
    ...
    var Select_Field = function (Field, ActiveID , CallBack ) {
    var Sql = "Select "+Field+" From ShopActive Where ActiveID=?ActiveID";
    var Values = {};
    Values.ActiveID = ActiveID;
    client.Query ( Sql , Values , function ( err , Result ) {
        if ( Result.length > 0 ) {
...
exports.Select = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/ShopActive.js=>Select 缺少参数");
    CallBack(false,null);
}

/*-----根据条件查询记录--------------*/
var SelectByFilter = function ( Filter , CallBack ) {
    var Sql = "Select * From ShopActive Where " + Filter + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var SelectByFilter_Field = function (Field, Filter , CallBack ) {
    var Sql = "Select "+Field+" From ShopActive Where " + Filter + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports.SelectByFilter = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/ShopActive.js=>SelectByFilter 缺少参数");
    CallBack(false,null);
}
...
exports.Insert = function ( Model , CallBack ) {
    var Sql = "Insert Into ShopActive Set ShopID=?ShopID,ShopName=?ShopName,Title=?Title,Info=?Info,ActiveShopLabel=?ActiveShopLabel,ShopType=?ShopType,ImgUrl=?ImgUrl,ActiveTargetUrl=?ActiveTargetUrl,BeginTime=?BeginTime,EndTime=?EndTime,CreateTime=?CreateTime ";
...
exports.Update = function ( Model , CallBack ) {
    var Sql = "Update ShopActive Set  ShopID=?ShopID,ShopName=?ShopName,Title=?Title,Info=?Info,ActiveShopLabel=?ActiveShopLabel,ShopType=?ShopType,ImgUrl=?ImgUrl,ActiveTargetUrl=?ActiveTargetUrl,BeginTime=?BeginTime,EndTime=?EndTime,CreateTime=?CreateTime Where ActiveID=?ActiveID";
    client.Query ( Sql , Model , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
/**
 * 更新字段值 ShopID
 * @param Key  主键值 Key:ActiveID
 * @param Value ShopID的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_ShopID = function ( ActiveID , Value , CallBack ) {
    var Sql = "Update ShopActive Set ShopID=?ShopID where ActiveID=?ActiveID";
    var Model = {};
    Model.Value = Value;
 ...
 * @constructor
 */
exports.Set_ShopName = function ( ActiveID , Value , CallBack ) {
    var Sql = "Update ShopActive Set ShopName=?ShopName where ActiveID=?ActiveID";
    var Model = {};
    Model.Value = Value;
    Model.ActiveID = ActiveID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * @constructor
 */
exports.Set_Title = function ( ActiveID , Value , CallBack ) {
    var Sql = "Update ShopActive Set Title=?Title where ActiveID=?ActiveID";
    var Model = {};
    Model.Value = Value;
    Model.ActiveID = ActiveID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * @constructor
 */
exports.Set_Info = function ( ActiveID , Value , CallBack ) {
    var Sql = "Update ShopActive Set Info=?Info where ActiveID=?ActiveID";
    var Model = {};
    Model.Value = Value;
    Model.ActiveID = ActiveID;
    client.Query ( Sql , Model , function ( err , Result ) {
...
/**
 * 更新字段值 ActiveShopLabel
 * @param Key  主键值 Key:ActiveID
 * @param Value ActiveShopLabel的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_ActiveShopLabel = function ( ActiveID , Value , CallBack ) {
    var Sql = "Update ShopActive Set ActiveShopLabel=?ActiveShopLabel where ActiveID=?ActiveID";
    var Model = {};
    Model.Value = Value;
    Model.ActiveID = ActiveID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * @constructor
 */
exports.Set_ShopType = function ( ActiveID , Value , CallBack ) {
    var Sql = "Update ShopActive Set ShopType=?ShopType where ActiveID=?ActiveID";
    var Model = {};
    Model.Value = Value;
    Model.ActiveID = ActiveID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * 更新字段值 ImgUrl
 * @param Key  主键值 Key:ActiveID
 * @param Value ImgUrl的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_ImgUrl = function ( ActiveID , Value , CallBack ) {
    var Sql = "Update ShopActive Set ImgUrl=?ImgUrl where ActiveID=?ActiveID";
    var Model = {};
    Model.Value = Value;
    Model.ActiveID = ActiveID;
    client.Query ( Sql , Model , function ( err , Result ) {
...
/**
 * 更新字段值 ActiveTargetUrl
 * @param Key  主键值 Key:ActiveID
 * @param Value ActiveTargetUrl的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_ActiveTargetUrl = function ( ActiveID , Value , CallBack ) {
    var Sql = "Update ShopActive Set ActiveTargetUrl=?ActiveTargetUrl where ActiveID=?ActiveID";
    var Model = {};
    Model.Value = Value;
    Model.ActiveID = ActiveID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * 更新字段值 BeginTime
 * @param Key  主键值 Key:ActiveID
 * @param Value BeginTime的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_BeginTime = function ( ActiveID , Value , CallBack ) {
    var Sql = "Update ShopActive Set BeginTime=?BeginTime where ActiveID=?ActiveID";
    var Model = {};
    Model.Value = Value;
    Model.ActiveID = ActiveID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * 更新字段值 EndTime
 * @param Key  主键值 Key:ActiveID
 * @param Value EndTime的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_EndTime = function ( ActiveID , Value , CallBack ) {
    var Sql = "Update ShopActive Set EndTime=?EndTime where ActiveID=?ActiveID";
    var Model = {};
    Model.Value = Value;
    Model.ActiveID = ActiveID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * @constructor
 */
exports.Set_CreateTime = function ( ActiveID , Value , CallBack ) {
    var Sql = "Update ShopActive Set CreateTime=?CreateTime where ActiveID=?ActiveID";
    var Model = {};
    Model.Value = Value;
    Model.ActiveID = ActiveID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * @constructor
 */
exports.Delete=function(ActiveID,CallBack){
    var Sql = "Delete From ShopActive Where ActiveID=?ActiveID";
    var Model={};
    Model.ActiveID=ActiveID;
    client.Query ( Sql , Model , function ( err , Result ) {
        CallBack ( err , Result );
...
exports.DeleteAll=function(CallBack){
    var Sql = "Delete From ShopActive";
    client.Query ( Sql  , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var DeleteByFilter=function(Filter,CallBack){
    var Sql = "Delete From ShopActive where "+Filter+"";
    client.Query ( Sql  , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports. DeleteByFilter=function(){
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/ShopActive.js=>DeleteByFilter 缺少参数");
    CallBack(false,null);
}
...
var GetPageRow = function ( CurPage , PageSize , Filter , CallBack ) {
    ...
    var Sql = "Select *  from ShopActive  where " + Filter + "  limit " + (PageSize * (CurPage - 1)) + "," + PageSize + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var GetPageRow_Field = function ( Field , CurPage , PageSize , Filter , CallBack ) {
    if(Filter=="")  Filter="1=1";
    var Sql = "Select " + Field + "  from ShopActive  where " + Filter + "  limit " + (PageSize * (CurPage - 1)) + "," + PageSize + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports.GetPageRow=function(){
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/ShopActive.js=>GetPageRow 缺少参数");
    CallBack(false,null);
}
