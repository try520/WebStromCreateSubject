...
var GetRsCount=function(Filter,CallBack){
    var Sql = "Select Count(*) as Count From Tabel_ID Where " + Filter + "";
...
exports.GetRsCount = function () {
    ...
    console.log("Access/Tabel_ID.js=>GetRsCount 缺少参数");
    CallBack(false,null);
}
/*-----统计求和--------------*/
var Sum=function(Field,Filter,CallBack){
    var Sql = "Select Sum("+Field+") as SumCount From Tabel_ID Where "+Filter+"";
    client.Query ( Sql , function ( err , Result ) {
...
exports.Sum = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/Tabel_ID.js=>Sum 缺少参数");
    CallBack(false,null);
}

/*-----查询所有记录--------------*/
var SelectAll = function ( CallBack ) {
    var Sql = "Select * From Tabel_ID";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var SelectAll_Field = function (Field, CallBack ) {
    var Sql = "Select "+Field+" From Tabel_ID";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var SelectAllByOrder = function (Field ,  Order , CallBack ) {
    var Sql = "Select "+Field+" From Tabel_ID  Order By " + Order;
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports.SelectAll = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/Tabel_ID.js=>SelectAll 缺少参数");
    CallBack(false,null);
}
/*-----根据关键字查询记录--------------*/

var Select = function ( TabelName , CallBack ) {
    var Sql = "Select * From Tabel_ID Where TabelName=?TabelName";
    var Values = {};
    Values.TabelName = TabelName;
    client.Query ( Sql , Values , function ( err , Result ) {
        if ( Result.length > 0 ) {
    ...
    var Select_Field = function (Field, TabelName , CallBack ) {
    var Sql = "Select "+Field+" From Tabel_ID Where TabelName=?TabelName";
    var Values = {};
    Values.TabelName = TabelName;
    client.Query ( Sql , Values , function ( err , Result ) {
        if ( Result.length > 0 ) {
...
exports.Select = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/Tabel_ID.js=>Select 缺少参数");
    CallBack(false,null);
}

/*-----根据条件查询记录--------------*/
var SelectByFilter = function ( Filter , CallBack ) {
    var Sql = "Select * From Tabel_ID Where " + Filter + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var SelectByFilter_Field = function (Field, Filter , CallBack ) {
    var Sql = "Select "+Field+" From Tabel_ID Where " + Filter + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports.SelectByFilter = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/Tabel_ID.js=>SelectByFilter 缺少参数");
    CallBack(false,null);
}
...
exports.Insert = function ( Model , CallBack ) {
    var Sql = "Insert Into Tabel_ID Set TabelName=?TabelName,IntValue=?IntValue ";
...
exports.Update = function ( Model , CallBack ) {
    var Sql = "Update Tabel_ID Set  TabelName=?TabelName,IntValue=?IntValue Where TabelName=?TabelName";
    client.Query ( Sql , Model , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
/**
 * 更新字段值 TabelName
 * @param Key  主键值 Key:TabelName
 * @param Value TabelName的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_TabelName = function ( TabelName , Value , CallBack ) {
    var Sql = "Update Tabel_ID Set TabelName=?TabelName where TabelName=?TabelName";
    var Model = {};
    Model.Value = Value;
    Model.TabelName = TabelName;
    client.Query ( Sql , Model , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
 ...
 * 更新字段值 IntValue
 * @param Key  主键值 Key:TabelName
 * @param Value IntValue的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_IntValue = function ( TabelName , Value , CallBack ) {
    var Sql = "Update Tabel_ID Set IntValue=?IntValue where TabelName=?TabelName";
    var Model = {};
    Model.Value = Value;
    Model.TabelName = TabelName;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * @constructor
 */
exports.Delete=function(TabelName,CallBack){
    var Sql = "Delete From Tabel_ID Where TabelName=?TabelName";
    var Model={};
    Model.TabelName=TabelName;
    client.Query ( Sql , Model , function ( err , Result ) {
        CallBack ( err , Result );
...
var DeleteByFilter=function(Filter,CallBack){
    var Sql = "Delete From Tabel_ID where "+Filter+"";
    client.Query ( Sql  , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports. DeleteByFilter=function(){
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/Tabel_ID.js=>DeleteByFilter 缺少参数");
    CallBack(false,null);
}
...
var GetPageRow = function ( CurPage , PageSize , Filter , CallBack ) {
    ...
    var Sql = "Select *  from Tabel_ID  where " + Filter + "  limit " + (PageSize * (CurPage - 1)) + "," + PageSize + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var GetPageRow_Field = function ( Field , CurPage , PageSize , Filter , CallBack ) {
    if(Filter=="")  Filter="1=1";
    var Sql = "Select " + Field + "  from Tabel_ID  where " + Filter + "  limit " + (PageSize * (CurPage - 1)) + "," + PageSize + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports.GetPageRow=function(){
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/Tabel_ID.js=>GetPageRow 缺少参数");
    CallBack(false,null);
}
