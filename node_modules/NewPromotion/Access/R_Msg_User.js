...
var GetRsCount=function(Filter,CallBack){
    var Sql = "Select Count(*) as Count From R_Msg_User Where " + Filter + "";
...
exports.GetRsCount = function () {
    ...
    console.log("Access/R_Msg_User.js=>GetRsCount 缺少参数");
    CallBack(false,null);
}
/*-----统计求和--------------*/
var Sum=function(Field,Filter,CallBack){
    var Sql = "Select Sum("+Field+") as SumCount From R_Msg_User Where "+Filter+"";
    client.Query ( Sql , function ( err , Result ) {
...
exports.Sum = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/R_Msg_User.js=>Sum 缺少参数");
    CallBack(false,null);
}

/*-----查询所有记录--------------*/
var SelectAll = function ( CallBack ) {
    var Sql = "Select * From R_Msg_User";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var SelectAll_Field = function (Field, CallBack ) {
    var Sql = "Select "+Field+" From R_Msg_User";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var SelectAllByOrder = function (Field ,  Order , CallBack ) {
    var Sql = "Select "+Field+" From R_Msg_User  Order By " + Order;
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports.SelectAll = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/R_Msg_User.js=>SelectAll 缺少参数");
    CallBack(false,null);
}
/*-----根据关键字查询记录--------------*/

var Select = function ( RID , CallBack ) {
    var Sql = "Select * From R_Msg_User Where RID=?RID";
    var Values = {};
    Values.RID = RID;
    client.Query ( Sql , Values , function ( err , Result ) {
        if ( Result.length > 0 ) {
    ...
    var Select_Field = function (Field, RID , CallBack ) {
    var Sql = "Select "+Field+" From R_Msg_User Where RID=?RID";
    var Values = {};
    Values.RID = RID;
    client.Query ( Sql , Values , function ( err , Result ) {
        if ( Result.length > 0 ) {
...
exports.Select = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/R_Msg_User.js=>Select 缺少参数");
    CallBack(false,null);
}

/*-----根据条件查询记录--------------*/
var SelectByFilter = function ( Filter , CallBack ) {
    var Sql = "Select * From R_Msg_User Where " + Filter + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var SelectByFilter_Field = function (Field, Filter , CallBack ) {
    var Sql = "Select "+Field+" From R_Msg_User Where " + Filter + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports.SelectByFilter = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/R_Msg_User.js=>SelectByFilter 缺少参数");
    CallBack(false,null);
}
...
exports.Insert = function ( Model , CallBack ) {
    var Sql = "Insert Into R_Msg_User Set RID=?RID,MsgID=?MsgID,UserID=?UserID,MsgType=?MsgType,IsRead=?IsRead ";
...
exports.Update = function ( Model , CallBack ) {
    var Sql = "Update R_Msg_User Set  RID=?RID,MsgID=?MsgID,UserID=?UserID,MsgType=?MsgType,IsRead=?IsRead Where RID=?RID";
    client.Query ( Sql , Model , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
/**
 * 更新字段值 RID
 * @param Key  主键值 Key:RID
 * @param Value RID的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_RID = function ( RID , Value , CallBack ) {
    var Sql = "Update R_Msg_User Set RID=?RID where RID=?RID";
    var Model = {};
    Model.Value = Value;
    Model.RID = RID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * @constructor
 */
exports.Set_MsgID = function ( RID , Value , CallBack ) {
    var Sql = "Update R_Msg_User Set MsgID=?MsgID where RID=?RID";
    var Model = {};
    Model.Value = Value;
    Model.RID = RID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * @constructor
 */
exports.Set_UserID = function ( RID , Value , CallBack ) {
    var Sql = "Update R_Msg_User Set UserID=?UserID where RID=?RID";
    var Model = {};
    Model.Value = Value;
    Model.RID = RID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * 更新字段值 MsgType
 * @param Key  主键值 Key:RID
 * @param Value MsgType的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_MsgType = function ( RID , Value , CallBack ) {
    var Sql = "Update R_Msg_User Set MsgType=?MsgType where RID=?RID";
    var Model = {};
    Model.Value = Value;
    Model.RID = RID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * 更新字段值 IsRead
 * @param Key  主键值 Key:RID
 * @param Value IsRead的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_IsRead = function ( RID , Value , CallBack ) {
    var Sql = "Update R_Msg_User Set IsRead=?IsRead where RID=?RID";
    var Model = {};
    Model.Value = Value;
    Model.RID = RID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * @constructor
 */
exports.Delete=function(RID,CallBack){
    var Sql = "Delete From R_Msg_User Where RID=?RID";
    var Model={};
    Model.RID=RID;
    client.Query ( Sql , Model , function ( err , Result ) {
        CallBack ( err , Result );
...
exports.DeleteAll=function(CallBack){
    var Sql = "Delete From R_Msg_User";
    client.Query ( Sql  , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var DeleteByFilter=function(Filter,CallBack){
    var Sql = "Delete From R_Msg_User where "+Filter+"";
    client.Query ( Sql  , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports. DeleteByFilter=function(){
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/R_Msg_User.js=>DeleteByFilter 缺少参数");
    CallBack(false,null);
}
...
var GetPageRow = function ( CurPage , PageSize , Filter , CallBack ) {
    ...
    var Sql = "Select *  from R_Msg_User  where " + Filter + "  limit " + (PageSize * (CurPage - 1)) + "," + PageSize + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var GetPageRow_Field = function ( Field , CurPage , PageSize , Filter , CallBack ) {
    if(Filter=="")  Filter="1=1";
    var Sql = "Select " + Field + "  from R_Msg_User  where " + Filter + "  limit " + (PageSize * (CurPage - 1)) + "," + PageSize + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports.GetPageRow=function(){
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/R_Msg_User.js=>GetPageRow 缺少参数");
    CallBack(false,null);
}
