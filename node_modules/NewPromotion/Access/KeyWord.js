...
var GetRsCount=function(Filter,CallBack){
    var Sql = "Select Count(*) as Count From KeyWord Where " + Filter + "";
...
exports.GetRsCount = function () {
    ...
    console.log("Access/KeyWord.js=>GetRsCount 缺少参数");
    CallBack(false,null);
}
/*-----统计求和--------------*/
var Sum=function(Field,Filter,CallBack){
    var Sql = "Select Sum("+Field+") as SumCount From KeyWord Where "+Filter+"";
    client.Query ( Sql , function ( err , Result ) {
...
exports.Sum = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/KeyWord.js=>Sum 缺少参数");
    CallBack(false,null);
}
...
var SelectAll_Field = function (Field, CallBack ) {
    var Sql = "Select "+Field+" From KeyWord";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var SelectAllByOrder = function (Field ,  Order , CallBack ) {
    var Sql = "Select "+Field+" From KeyWord  Order By " + Order;
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports.SelectAll = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/KeyWord.js=>SelectAll 缺少参数");
    CallBack(false,null);
}
/*-----根据关键字查询记录--------------*/

var Select = function ( KeyWordID , CallBack ) {
    var Sql = "Select * From KeyWord Where KeyWordID=?KeyWordID";
    var Values = {};
    Values.KeyWordID = KeyWordID;
    client.Query ( Sql , Values , function ( err , Result ) {
        if ( Result.length > 0 ) {
    ...
    var Select_Field = function (Field, KeyWordID , CallBack ) {
    var Sql = "Select "+Field+" From KeyWord Where KeyWordID=?KeyWordID";
    var Values = {};
    Values.KeyWordID = KeyWordID;
    client.Query ( Sql , Values , function ( err , Result ) {
        if ( Result.length > 0 ) {
...
exports.Select = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/KeyWord.js=>Select 缺少参数");
    CallBack(false,null);
}

/*-----根据条件查询记录--------------*/
var SelectByFilter = function ( Filter , CallBack ) {
    var Sql = "Select * From KeyWord Where " + Filter + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var SelectByFilter_Field = function (Field, Filter , CallBack ) {
    var Sql = "Select "+Field+" From KeyWord Where " + Filter + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports.SelectByFilter = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/KeyWord.js=>SelectByFilter 缺少参数");
    CallBack(false,null);
}
...
exports.Insert = function ( Model , CallBack ) {
    var Sql = "Insert Into KeyWord Set KeyWordName=?KeyWordName,KeyWordLabel=?KeyWordLabel,KeyWordSiteLabelID=?KeyWordSiteLabelID,KeyWordProdCount=?KeyWordProdCount,KeyWordHotCount=?KeyWordHotCount ";
...
exports.Update = function ( Model , CallBack ) {
    var Sql = "Update KeyWord Set  KeyWordName=?KeyWordName,KeyWordLabel=?KeyWordLabel,KeyWordSiteLabelID=?KeyWordSiteLabelID,KeyWordProdCount=?KeyWordProdCount,KeyWordHotCount=?KeyWordHotCount Where KeyWordID=?KeyWordID";
    client.Query ( Sql , Model , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
/**
 * 更新字段值 KeyWordName
 * @param Key  主键值 Key:KeyWordID
 * @param Value KeyWordName的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_KeyWordName = function ( KeyWordID , Value , CallBack ) {
    var Sql = "Update KeyWord Set KeyWordName=?KeyWordName where KeyWordID=?KeyWordID";
    var Model = {};
    Model.Value = Value;
 ...
 * @constructor
 */
exports.Set_KeyWordLabel = function ( KeyWordID , Value , CallBack ) {
    var Sql = "Update KeyWord Set KeyWordLabel=?KeyWordLabel where KeyWordID=?KeyWordID";
    var Model = {};
    Model.Value = Value;
    Model.KeyWordID = KeyWordID;
    client.Query ( Sql , Model , function ( err , Result ) {
...
/**
 * 更新字段值 KeyWordSiteLabelID
 * @param Key  主键值 Key:KeyWordID
 * @param Value KeyWordSiteLabelID的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_KeyWordSiteLabelID = function ( KeyWordID , Value , CallBack ) {
    var Sql = "Update KeyWord Set KeyWordSiteLabelID=?KeyWordSiteLabelID where KeyWordID=?KeyWordID";
    var Model = {};
    Model.Value = Value;
    Model.KeyWordID = KeyWordID;
    client.Query ( Sql , Model , function ( err , Result ) {
...
/**
 * 更新字段值 KeyWordProdCount
 * @param Key  主键值 Key:KeyWordID
 * @param Value KeyWordProdCount的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_KeyWordProdCount = function ( KeyWordID , Value , CallBack ) {
    var Sql = "Update KeyWord Set KeyWordProdCount=?KeyWordProdCount where KeyWordID=?KeyWordID";
    var Model = {};
    Model.Value = Value;
    Model.KeyWordID = KeyWordID;
    client.Query ( Sql , Model , function ( err , Result ) {
...
/**
 * 更新字段值 KeyWordHotCount
 * @param Key  主键值 Key:KeyWordID
 * @param Value KeyWordHotCount的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_KeyWordHotCount = function ( KeyWordID , Value , CallBack ) {
    var Sql = "Update KeyWord Set KeyWordHotCount=?KeyWordHotCount where KeyWordID=?KeyWordID";
    var Model = {};
    Model.Value = Value;
    Model.KeyWordID = KeyWordID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * @constructor
 */
exports.Delete=function(KeyWordID,CallBack){
    var Sql = "Delete From KeyWord Where KeyWordID=?KeyWordID";
    var Model={};
    Model.KeyWordID=KeyWordID;
    client.Query ( Sql , Model , function ( err , Result ) {
        CallBack ( err , Result );
...
var DeleteByFilter=function(Filter,CallBack){
    var Sql = "Delete From KeyWord where "+Filter+"";
    client.Query ( Sql  , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports. DeleteByFilter=function(){
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/KeyWord.js=>DeleteByFilter 缺少参数");
    CallBack(false,null);
}
...
var GetPageRow = function ( CurPage , PageSize , Filter , CallBack ) {
    ...
    var Sql = "Select *  from KeyWord  where " + Filter + "  limit " + (PageSize * (CurPage - 1)) + "," + PageSize + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var GetPageRow_Field = function ( Field , CurPage , PageSize , Filter , CallBack ) {
    if(Filter=="")  Filter="1=1";
    var Sql = "Select " + Field + "  from KeyWord  where " + Filter + "  limit " + (PageSize * (CurPage - 1)) + "," + PageSize + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports.GetPageRow=function(){
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/KeyWord.js=>GetPageRow 缺少参数");
    CallBack(false,null);
}
