...
var GetRsCount=function(Filter,CallBack){
    var Sql = "Select Count(*) as Count From UserPay Where " + Filter + "";
...
exports.GetRsCount = function () {
    ...
    console.log("Access/UserPay.js=>GetRsCount 缺少参数");
    CallBack(false,null);
}
/*-----统计求和--------------*/
var Sum=function(Field,Filter,CallBack){
    var Sql = "Select Sum("+Field+") as SumCount From UserPay Where "+Filter+"";
    client.Query ( Sql , function ( err , Result ) {
...
exports.Sum = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/UserPay.js=>Sum 缺少参数");
    CallBack(false,null);
}

/*-----查询所有记录--------------*/
var SelectAll = function ( CallBack ) {
    var Sql = "Select * From UserPay";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var SelectAll_Field = function (Field, CallBack ) {
    var Sql = "Select "+Field+" From UserPay";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var SelectAllByOrder = function (Field ,  Order , CallBack ) {
    var Sql = "Select "+Field+" From UserPay  Order By " + Order;
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports.SelectAll = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/UserPay.js=>SelectAll 缺少参数");
    CallBack(false,null);
}
/*-----根据关键字查询记录--------------*/

var Select = function ( PayID , CallBack ) {
    var Sql = "Select * From UserPay Where PayID=?PayID";
    var Values = {};
    Values.PayID = PayID;
    client.Query ( Sql , Values , function ( err , Result ) {
        if ( Result.length > 0 ) {
    ...
    var Select_Field = function (Field, PayID , CallBack ) {
    var Sql = "Select "+Field+" From UserPay Where PayID=?PayID";
    var Values = {};
    Values.PayID = PayID;
    client.Query ( Sql , Values , function ( err , Result ) {
        if ( Result.length > 0 ) {
...
exports.Select = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/UserPay.js=>Select 缺少参数");
    CallBack(false,null);
}

/*-----根据条件查询记录--------------*/
var SelectByFilter = function ( Filter , CallBack ) {
    var Sql = "Select * From UserPay Where " + Filter + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var SelectByFilter_Field = function (Field, Filter , CallBack ) {
    var Sql = "Select "+Field+" From UserPay Where " + Filter + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports.SelectByFilter = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/UserPay.js=>SelectByFilter 缺少参数");
    CallBack(false,null);
}
...
exports.Insert = function ( Model , CallBack ) {
    var Sql = "Insert Into UserPay Set Money=?Money,UserID=?UserID,Wtime=?Wtime,Remark=?Remark,PayType=?PayType ";
...
exports.Update = function ( Model , CallBack ) {
    var Sql = "Update UserPay Set  Money=?Money,UserID=?UserID,Wtime=?Wtime,Remark=?Remark,PayType=?PayType Where PayID=?PayID";
    client.Query ( Sql , Model , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
/**
 * 更新字段值 Money
 * @param Key  主键值 Key:PayID
 * @param Value Money的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_Money = function ( PayID , Value , CallBack ) {
    var Sql = "Update UserPay Set Money=?Money where PayID=?PayID";
    var Model = {};
    Model.Value = Value;
    Model.PayID = PayID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * @constructor
 */
exports.Set_UserID = function ( PayID , Value , CallBack ) {
    var Sql = "Update UserPay Set UserID=?UserID where PayID=?PayID";
    var Model = {};
    Model.Value = Value;
    Model.PayID = PayID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * @constructor
 */
exports.Set_Wtime = function ( PayID , Value , CallBack ) {
    var Sql = "Update UserPay Set Wtime=?Wtime where PayID=?PayID";
    var Model = {};
    Model.Value = Value;
    Model.PayID = PayID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * @constructor
 */
exports.Set_Remark = function ( PayID , Value , CallBack ) {
    var Sql = "Update UserPay Set Remark=?Remark where PayID=?PayID";
    var Model = {};
    Model.Value = Value;
    Model.PayID = PayID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * 更新字段值 PayType
 * @param Key  主键值 Key:PayID
 * @param Value PayType的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_PayType = function ( PayID , Value , CallBack ) {
    var Sql = "Update UserPay Set PayType=?PayType where PayID=?PayID";
    var Model = {};
    Model.Value = Value;
    Model.PayID = PayID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * @constructor
 */
exports.Delete=function(PayID,CallBack){
    var Sql = "Delete From UserPay Where PayID=?PayID";
    var Model={};
    Model.PayID=PayID;
    client.Query ( Sql , Model , function ( err , Result ) {
        CallBack ( err , Result );
...
var DeleteByFilter=function(Filter,CallBack){
    var Sql = "Delete From UserPay where "+Filter+"";
    client.Query ( Sql  , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports. DeleteByFilter=function(){
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/UserPay.js=>DeleteByFilter 缺少参数");
    CallBack(false,null);
}
...
var GetPageRow = function ( CurPage , PageSize , Filter , CallBack ) {
    ...
    var Sql = "Select *  from UserPay  where " + Filter + "  limit " + (PageSize * (CurPage - 1)) + "," + PageSize + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var GetPageRow_Field = function ( Field , CurPage , PageSize , Filter , CallBack ) {
    if(Filter=="")  Filter="1=1";
    var Sql = "Select " + Field + "  from UserPay  where " + Filter + "  limit " + (PageSize * (CurPage - 1)) + "," + PageSize + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports.GetPageRow=function(){
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/UserPay.js=>GetPageRow 缺少参数");
    CallBack(false,null);
}
