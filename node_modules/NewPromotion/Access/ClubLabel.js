...
var GetRsCount=function(Filter,CallBack){
    var Sql = "Select Count(*) as Count From ClubLabel Where " + Filter + "";
...
exports.GetRsCount = function () {
    ...
    console.log("Access/ClubLabel.js=>GetRsCount 缺少参数");
    CallBack(false,null);
}
/*-----统计求和--------------*/
var Sum=function(Field,Filter,CallBack){
    var Sql = "Select Sum("+Field+") as SumCount From ClubLabel Where "+Filter+"";
    client.Query ( Sql , function ( err , Result ) {
...
exports.Sum = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/ClubLabel.js=>Sum 缺少参数");
    CallBack(false,null);
}

/*-----查询所有记录--------------*/
var SelectAll = function ( CallBack ) {
    var Sql = "Select * From ClubLabel";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var SelectAll_Field = function (Field, CallBack ) {
    var Sql = "Select "+Field+" From ClubLabel";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var SelectAllByOrder = function (Field ,  Order , CallBack ) {
    var Sql = "Select "+Field+" From ClubLabel  Order By " + Order;
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports.SelectAll = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/ClubLabel.js=>SelectAll 缺少参数");
    CallBack(false,null);
}
/*-----根据关键字查询记录--------------*/

var Select = function ( ClubLabelID , CallBack ) {
    var Sql = "Select * From ClubLabel Where ClubLabelID=?ClubLabelID";
    var Values = {};
    Values.ClubLabelID = ClubLabelID;
    client.Query ( Sql , Values , function ( err , Result ) {
        if ( Result.length > 0 ) {
    ...
    var Select_Field = function (Field, ClubLabelID , CallBack ) {
    var Sql = "Select "+Field+" From ClubLabel Where ClubLabelID=?ClubLabelID";
    var Values = {};
    Values.ClubLabelID = ClubLabelID;
    client.Query ( Sql , Values , function ( err , Result ) {
        if ( Result.length > 0 ) {
...
exports.Select = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/ClubLabel.js=>Select 缺少参数");
    CallBack(false,null);
}

/*-----根据条件查询记录--------------*/
var SelectByFilter = function ( Filter , CallBack ) {
    var Sql = "Select * From ClubLabel Where " + Filter + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var SelectByFilter_Field = function (Field, Filter , CallBack ) {
    var Sql = "Select "+Field+" From ClubLabel Where " + Filter + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports.SelectByFilter = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/ClubLabel.js=>SelectByFilter 缺少参数");
    CallBack(false,null);
}
...
exports.Insert = function ( Model , CallBack ) {
    var Sql = "Insert Into ClubLabel Set LableName=?LableName,Label_ModuleID=?Label_ModuleID,LabelSort=?LabelSort,LabelThreadCount=?LabelThreadCount ";
...
exports.Update = function ( Model , CallBack ) {
    var Sql = "Update ClubLabel Set  LableName=?LableName,Label_ModuleID=?Label_ModuleID,LabelSort=?LabelSort,LabelThreadCount=?LabelThreadCount Where ClubLabelID=?ClubLabelID";
    client.Query ( Sql , Model , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
/**
 * 更新字段值 LableName
 * @param Key  主键值 Key:ClubLabelID
 * @param Value LableName的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_LableName = function ( ClubLabelID , Value , CallBack ) {
    var Sql = "Update ClubLabel Set LableName=?LableName where ClubLabelID=?ClubLabelID";
    var Model = {};
    Model.Value = Value;
    Model.ClubLabelID = ClubLabelID;
    client.Query ( Sql , Model , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
/**
 * 更新字段值 Label_ModuleID
 * @param Key  主键值 Key:ClubLabelID
 * @param Value Label_ModuleID的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_Label_ModuleID = function ( ClubLabelID , Value , CallBack ) {
    var Sql = "Update ClubLabel Set Label_ModuleID=?Label_ModuleID where ClubLabelID=?ClubLabelID";
    var Model = {};
    Model.Value = Value;
    Model.ClubLabelID = ClubLabelID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * 更新字段值 LabelSort
 * @param Key  主键值 Key:ClubLabelID
 * @param Value LabelSort的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_LabelSort = function ( ClubLabelID , Value , CallBack ) {
    var Sql = "Update ClubLabel Set LabelSort=?LabelSort where ClubLabelID=?ClubLabelID";
    var Model = {};
    Model.Value = Value;
    Model.ClubLabelID = ClubLabelID;
    client.Query ( Sql , Model , function ( err , Result ) {
...
/**
 * 更新字段值 LabelThreadCount
 * @param Key  主键值 Key:ClubLabelID
 * @param Value LabelThreadCount的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_LabelThreadCount = function ( ClubLabelID , Value , CallBack ) {
    var Sql = "Update ClubLabel Set LabelThreadCount=?LabelThreadCount where ClubLabelID=?ClubLabelID";
    var Model = {};
    Model.Value = Value;
    Model.ClubLabelID = ClubLabelID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * @constructor
 */
exports.Delete=function(ClubLabelID,CallBack){
    var Sql = "Delete From ClubLabel Where ClubLabelID=?ClubLabelID";
    var Model={};
    Model.ClubLabelID=ClubLabelID;
    client.Query ( Sql , Model , function ( err , Result ) {
        CallBack ( err , Result );
...
var DeleteByFilter=function(Filter,CallBack){
    var Sql = "Delete From ClubLabel where "+Filter+"";
    client.Query ( Sql  , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports. DeleteByFilter=function(){
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/ClubLabel.js=>DeleteByFilter 缺少参数");
    CallBack(false,null);
}
...
var GetPageRow = function ( CurPage , PageSize , Filter , CallBack ) {
    ...
    var Sql = "Select *  from ClubLabel  where " + Filter + "  limit " + (PageSize * (CurPage - 1)) + "," + PageSize + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var GetPageRow_Field = function ( Field , CurPage , PageSize , Filter , CallBack ) {
    if(Filter=="")  Filter="1=1";
    var Sql = "Select " + Field + "  from ClubLabel  where " + Filter + "  limit " + (PageSize * (CurPage - 1)) + "," + PageSize + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports.GetPageRow=function(){
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/ClubLabel.js=>GetPageRow 缺少参数");
    CallBack(false,null);
}
