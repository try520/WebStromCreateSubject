...
var GetRsCount=function(Filter,CallBack){
    var Sql = "Select Count(*) as Count From ClubReqThread Where " + Filter + "";
...
exports.GetRsCount = function () {
    ...
    console.log("Access/ClubReqThread.js=>GetRsCount 缺少参数");
    CallBack(false,null);
}
/*-----统计求和--------------*/
var Sum=function(Field,Filter,CallBack){
    var Sql = "Select Sum("+Field+") as SumCount From ClubReqThread Where "+Filter+"";
    client.Query ( Sql , function ( err , Result ) {
...
exports.Sum = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/ClubReqThread.js=>Sum 缺少参数");
    CallBack(false,null);
}

/*-----查询所有记录--------------*/
var SelectAll = function ( CallBack ) {
    var Sql = "Select * From ClubReqThread";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var SelectAll_Field = function (Field, CallBack ) {
    var Sql = "Select "+Field+" From ClubReqThread";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var SelectAllByOrder = function (Field ,  Order , CallBack ) {
    var Sql = "Select "+Field+" From ClubReqThread  Order By " + Order;
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports.SelectAll = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/ClubReqThread.js=>SelectAll 缺少参数");
    CallBack(false,null);
}
/*-----根据关键字查询记录--------------*/

var Select = function ( ReqID , CallBack ) {
    var Sql = "Select * From ClubReqThread Where ReqID=?ReqID";
    var Values = {};
    Values.ReqID = ReqID;
    client.Query ( Sql , Values , function ( err , Result ) {
        if ( Result.length > 0 ) {
    ...
    var Select_Field = function (Field, ReqID , CallBack ) {
    var Sql = "Select "+Field+" From ClubReqThread Where ReqID=?ReqID";
    var Values = {};
    Values.ReqID = ReqID;
    client.Query ( Sql , Values , function ( err , Result ) {
        if ( Result.length > 0 ) {
...
exports.Select = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/ClubReqThread.js=>Select 缺少参数");
    CallBack(false,null);
}

/*-----根据条件查询记录--------------*/
var SelectByFilter = function ( Filter , CallBack ) {
    var Sql = "Select * From ClubReqThread Where " + Filter + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var SelectByFilter_Field = function (Field, Filter , CallBack ) {
    var Sql = "Select "+Field+" From ClubReqThread Where " + Filter + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports.SelectByFilter = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/ClubReqThread.js=>SelectByFilter 缺少参数");
    CallBack(false,null);
}
...
exports.Insert = function ( Model , CallBack ) {
    var Sql = "Insert Into ClubReqThread Set ReqID=?ReqID,ReqThreadID=?ReqThreadID,ReqUserID=?ReqUserID,ReqUserName=?ReqUserName,ReqContent=?ReqContent,ReqCreateTime=?ReqCreateTime,ReqProdID=?ReqProdID,ReqProdImg=?ReqProdImg,ReqProdType=?ReqProdType,SupportCount=?SupportCount,NoSupportCount=?NoSupportCount,AgreeCount=?AgreeCount ";
...
exports.Update = function ( Model , CallBack ) {
    var Sql = "Update ClubReqThread Set  ReqID=?ReqID,ReqThreadID=?ReqThreadID,ReqUserID=?ReqUserID,ReqUserName=?ReqUserName,ReqContent=?ReqContent,ReqCreateTime=?ReqCreateTime,ReqProdID=?ReqProdID,ReqProdImg=?ReqProdImg,ReqProdType=?ReqProdType,SupportCount=?SupportCount,NoSupportCount=?NoSupportCount,AgreeCount=?AgreeCount Where ReqID=?ReqID";
    client.Query ( Sql , Model , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
/**
 * 更新字段值 ReqID
 * @param Key  主键值 Key:ReqID
 * @param Value ReqID的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_ReqID = function ( ReqID , Value , CallBack ) {
    var Sql = "Update ClubReqThread Set ReqID=?ReqID where ReqID=?ReqID";
    var Model = {};
    Model.Value = Value;
    Model.ReqID = ReqID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * 更新字段值 ReqThreadID
 * @param Key  主键值 Key:ReqID
 * @param Value ReqThreadID的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_ReqThreadID = function ( ReqID , Value , CallBack ) {
    var Sql = "Update ClubReqThread Set ReqThreadID=?ReqThreadID where ReqID=?ReqID";
    var Model = {};
    Model.Value = Value;
    Model.ReqID = ReqID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * 更新字段值 ReqUserID
 * @param Key  主键值 Key:ReqID
 * @param Value ReqUserID的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_ReqUserID = function ( ReqID , Value , CallBack ) {
    var Sql = "Update ClubReqThread Set ReqUserID=?ReqUserID where ReqID=?ReqID";
    var Model = {};
    Model.Value = Value;
    Model.ReqID = ReqID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * 更新字段值 ReqUserName
 * @param Key  主键值 Key:ReqID
 * @param Value ReqUserName的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_ReqUserName = function ( ReqID , Value , CallBack ) {
    var Sql = "Update ClubReqThread Set ReqUserName=?ReqUserName where ReqID=?ReqID";
    var Model = {};
    Model.Value = Value;
    Model.ReqID = ReqID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * 更新字段值 ReqContent
 * @param Key  主键值 Key:ReqID
 * @param Value ReqContent的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_ReqContent = function ( ReqID , Value , CallBack ) {
    var Sql = "Update ClubReqThread Set ReqContent=?ReqContent where ReqID=?ReqID";
    var Model = {};
    Model.Value = Value;
    Model.ReqID = ReqID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * 更新字段值 ReqCreateTime
 * @param Key  主键值 Key:ReqID
 * @param Value ReqCreateTime的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_ReqCreateTime = function ( ReqID , Value , CallBack ) {
    var Sql = "Update ClubReqThread Set ReqCreateTime=?ReqCreateTime where ReqID=?ReqID";
    var Model = {};
    Model.Value = Value;
    Model.ReqID = ReqID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * 更新字段值 ReqProdID
 * @param Key  主键值 Key:ReqID
 * @param Value ReqProdID的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_ReqProdID = function ( ReqID , Value , CallBack ) {
    var Sql = "Update ClubReqThread Set ReqProdID=?ReqProdID where ReqID=?ReqID";
    var Model = {};
    Model.Value = Value;
    Model.ReqID = ReqID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * 更新字段值 ReqProdImg
 * @param Key  主键值 Key:ReqID
 * @param Value ReqProdImg的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_ReqProdImg = function ( ReqID , Value , CallBack ) {
    var Sql = "Update ClubReqThread Set ReqProdImg=?ReqProdImg where ReqID=?ReqID";
    var Model = {};
    Model.Value = Value;
    Model.ReqID = ReqID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * 更新字段值 ReqProdType
 * @param Key  主键值 Key:ReqID
 * @param Value ReqProdType的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_ReqProdType = function ( ReqID , Value , CallBack ) {
    var Sql = "Update ClubReqThread Set ReqProdType=?ReqProdType where ReqID=?ReqID";
    var Model = {};
    Model.Value = Value;
    Model.ReqID = ReqID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * 更新字段值 SupportCount
 * @param Key  主键值 Key:ReqID
 * @param Value SupportCount的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_SupportCount = function ( ReqID , Value , CallBack ) {
    var Sql = "Update ClubReqThread Set SupportCount=?SupportCount where ReqID=?ReqID";
    var Model = {};
    Model.Value = Value;
    Model.ReqID = ReqID;
    client.Query ( Sql , Model , function ( err , Result ) {
...
/**
 * 更新字段值 NoSupportCount
 * @param Key  主键值 Key:ReqID
 * @param Value NoSupportCount的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_NoSupportCount = function ( ReqID , Value , CallBack ) {
    var Sql = "Update ClubReqThread Set NoSupportCount=?NoSupportCount where ReqID=?ReqID";
    var Model = {};
    Model.Value = Value;
    Model.ReqID = ReqID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * 更新字段值 AgreeCount
 * @param Key  主键值 Key:ReqID
 * @param Value AgreeCount的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_AgreeCount = function ( ReqID , Value , CallBack ) {
    var Sql = "Update ClubReqThread Set AgreeCount=?AgreeCount where ReqID=?ReqID";
    var Model = {};
    Model.Value = Value;
    Model.ReqID = ReqID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * @constructor
 */
exports.Delete=function(ReqID,CallBack){
    var Sql = "Delete From ClubReqThread Where ReqID=?ReqID";
    var Model={};
    Model.ReqID=ReqID;
    client.Query ( Sql , Model , function ( err , Result ) {
        CallBack ( err , Result );
...
exports.DeleteAll=function(CallBack){
    var Sql = "Delete From ClubReqThread";
    client.Query ( Sql  , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var DeleteByFilter=function(Filter,CallBack){
    var Sql = "Delete From ClubReqThread where "+Filter+"";
    client.Query ( Sql  , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports. DeleteByFilter=function(){
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/ClubReqThread.js=>DeleteByFilter 缺少参数");
    CallBack(false,null);
}
...
var GetPageRow = function ( CurPage , PageSize , Filter , CallBack ) {
    ...
    var Sql = "Select *  from ClubReqThread  where " + Filter + "  limit " + (PageSize * (CurPage - 1)) + "," + PageSize + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var GetPageRow_Field = function ( Field , CurPage , PageSize , Filter , CallBack ) {
    if(Filter=="")  Filter="1=1";
    var Sql = "Select " + Field + "  from ClubReqThread  where " + Filter + "  limit " + (PageSize * (CurPage - 1)) + "," + PageSize + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports.GetPageRow=function(){
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/ClubReqThread.js=>GetPageRow 缺少参数");
    CallBack(false,null);
}
