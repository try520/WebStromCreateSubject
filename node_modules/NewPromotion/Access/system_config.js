...
var GetRsCount=function(Filter,CallBack){
    var Sql = "Select Count(*) as Count From system_config Where " + Filter + "";
...
exports.GetRsCount = function () {
    ...
    console.log("Access/system_config.js=>GetRsCount 缺少参数");
    CallBack(false,null);
}
/*-----统计求和--------------*/
var Sum=function(Field,Filter,CallBack){
    var Sql = "Select Sum("+Field+") as SumCount From system_config Where "+Filter+"";
    client.Query ( Sql , function ( err , Result ) {
...
exports.Sum = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/system_config.js=>Sum 缺少参数");
    CallBack(false,null);
}

/*-----查询所有记录--------------*/
var SelectAll = function ( CallBack ) {
    var Sql = "Select * From system_config";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var SelectAll_Field = function (Field, CallBack ) {
    var Sql = "Select "+Field+" From system_config";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var SelectAllByOrder = function (Field ,  Order , CallBack ) {
    var Sql = "Select "+Field+" From system_config  Order By " + Order;
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports.SelectAll = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/system_config.js=>SelectAll 缺少参数");
    CallBack(false,null);
}
/*-----根据关键字查询记录--------------*/

var Select = function ( Config_key , CallBack ) {
    var Sql = "Select * From system_config Where Config_key=?Config_key";
    var Values = {};
    ...
    var Select_Field = function (Field, Config_key , CallBack ) {
    var Sql = "Select "+Field+" From system_config Where Config_key=?Config_key";
    var Values = {};
    Values.Config_key = Config_key;
    client.Query ( Sql , Values , function ( err , Result ) {
        if ( Result.length > 0 ) {
...
exports.Select = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/system_config.js=>Select 缺少参数");
    CallBack(false,null);
}

/*-----根据条件查询记录--------------*/
var SelectByFilter = function ( Filter , CallBack ) {
    var Sql = "Select * From system_config Where " + Filter + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var SelectByFilter_Field = function (Field, Filter , CallBack ) {
    var Sql = "Select "+Field+" From system_config Where " + Filter + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports.SelectByFilter = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/system_config.js=>SelectByFilter 缺少参数");
    CallBack(false,null);
}
...
exports.Insert = function ( Model , CallBack ) {
    var Sql = "Insert Into system_config Set Config_key=?Config_key,Config_value=?Config_value,Remark=?Remark ";
...
exports.Update = function ( Model , CallBack ) {
    var Sql = "Update system_config Set  Config_key=?Config_key,Config_value=?Config_value,Remark=?Remark Where Config_key=?Config_key";
    client.Query ( Sql , Model , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
/**
 * 更新字段值 Config_key
 * @param Key  主键值 Key:Config_key
 * @param Value Config_key的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_Config_key = function ( Config_key , Value , CallBack ) {
    var Sql = "Update system_config Set Config_key=?Config_key where Config_key=?Config_key";
    var Model = {};
    Model.Value = Value;
 ...
 * 更新字段值 Config_value
 * @param Key  主键值 Key:Config_key
 * @param Value Config_value的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_Config_value = function ( Config_key , Value , CallBack ) {
    var Sql = "Update system_config Set Config_value=?Config_value where Config_key=?Config_key";
    var Model = {};
    Model.Value = Value;
    Model.Config_key = Config_key;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * @constructor
 */
exports.Set_Remark = function ( Config_key , Value , CallBack ) {
    var Sql = "Update system_config Set Remark=?Remark where Config_key=?Config_key";
    var Model = {};
    Model.Value = Value;
    Model.Config_key = Config_key;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * @constructor
 */
exports.Delete=function(Config_key,CallBack){
    var Sql = "Delete From system_config Where Config_key=?Config_key";
    var Model={};
    Model.Config_key=Config_key;
    client.Query ( Sql , Model , function ( err , Result ) {
        CallBack ( err , Result );
...
exports.DeleteAll=function(CallBack){
    var Sql = "Delete From system_config";
    client.Query ( Sql  , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var DeleteByFilter=function(Filter,CallBack){
    var Sql = "Delete From system_config where "+Filter+"";
    client.Query ( Sql  , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports. DeleteByFilter=function(){
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/system_config.js=>DeleteByFilter 缺少参数");
    CallBack(false,null);
}
...
var GetPageRow = function ( CurPage , PageSize , Filter , CallBack ) {
    ...
    var Sql = "Select *  from system_config  where " + Filter + "  limit " + (PageSize * (CurPage - 1)) + "," + PageSize + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var GetPageRow_Field = function ( Field , CurPage , PageSize , Filter , CallBack ) {
    if(Filter=="")  Filter="1=1";
    var Sql = "Select " + Field + "  from system_config  where " + Filter + "  limit " + (PageSize * (CurPage - 1)) + "," + PageSize + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports.GetPageRow=function(){
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/system_config.js=>GetPageRow 缺少参数");
    CallBack(false,null);
}
