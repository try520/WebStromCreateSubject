...
var GetRsCount=function(Filter,CallBack){
    var Sql = "Select Count(*) as Count From UserPoint Where " + Filter + "";
...
exports.GetRsCount = function () {
    ...
    console.log("Access/UserPoint.js=>GetRsCount 缺少参数");
    CallBack(false,null);
}
/*-----统计求和--------------*/
var Sum=function(Field,Filter,CallBack){
    var Sql = "Select Sum("+Field+") as SumCount From UserPoint Where "+Filter+"";
    client.Query ( Sql , function ( err , Result ) {
...
exports.Sum = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/UserPoint.js=>Sum 缺少参数");
    CallBack(false,null);
}

/*-----查询所有记录--------------*/
var SelectAll = function ( CallBack ) {
    var Sql = "Select * From UserPoint";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var SelectAll_Field = function (Field, CallBack ) {
    var Sql = "Select "+Field+" From UserPoint";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var SelectAllByOrder = function (Field ,  Order , CallBack ) {
    var Sql = "Select "+Field+" From UserPoint  Order By " + Order;
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports.SelectAll = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/UserPoint.js=>SelectAll 缺少参数");
    CallBack(false,null);
}
/*-----根据关键字查询记录--------------*/

var Select = function ( UserID , CallBack ) {
    var Sql = "Select * From UserPoint Where UserID=?UserID";
    var Values = {};
    ...
    var Sql = "Select "+Field+" From UserPoint Where UserID=?UserID";
    var Values = {};
    Values.UserID = UserID;
    client.Query ( Sql , Values , function ( err , Result ) {
        if ( Result.length > 0 ) {
...
exports.Select = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/UserPoint.js=>Select 缺少参数");
    CallBack(false,null);
}

/*-----根据条件查询记录--------------*/
var SelectByFilter = function ( Filter , CallBack ) {
    var Sql = "Select * From UserPoint Where " + Filter + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var SelectByFilter_Field = function (Field, Filter , CallBack ) {
    var Sql = "Select "+Field+" From UserPoint Where " + Filter + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports.SelectByFilter = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/UserPoint.js=>SelectByFilter 缺少参数");
    CallBack(false,null);
}
...
exports.Insert = function ( Model , CallBack ) {
    var Sql = "Insert Into UserPoint Set UserID=?UserID,Club_Thread_Point=?Club_Thread_Point ";
...
exports.Update = function ( Model , CallBack ) {
    var Sql = "Update UserPoint Set  UserID=?UserID,Club_Thread_Point=?Club_Thread_Point Where UserID=?UserID";
    client.Query ( Sql , Model , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports.Set_UserID = function ( UserID , Value , CallBack ) {
    var Sql = "Update UserPoint Set UserID=?UserID where UserID=?UserID";
    var Model = {};
    Model.Value = Value;
    Model.UserID = UserID;
    client.Query ( Sql , Model , function ( err , Result ) {
...
/**
 * 更新字段值 Club_Thread_Point
 * @param Key  主键值 Key:UserID
 * @param Value Club_Thread_Point的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_Club_Thread_Point = function ( UserID , Value , CallBack ) {
    var Sql = "Update UserPoint Set Club_Thread_Point=?Club_Thread_Point where UserID=?UserID";
    var Model = {};
    Model.Value = Value;
    Model.UserID = UserID;
    client.Query ( Sql , Model , function ( err , Result ) {
...
exports.Delete=function(UserID,CallBack){
    var Sql = "Delete From UserPoint Where UserID=?UserID";
    var Model={};
    Model.UserID=UserID;
    client.Query ( Sql , Model , function ( err , Result ) {
        CallBack ( err , Result );
...
var DeleteByFilter=function(Filter,CallBack){
    var Sql = "Delete From UserPoint where "+Filter+"";
    client.Query ( Sql  , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports. DeleteByFilter=function(){
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/UserPoint.js=>DeleteByFilter 缺少参数");
    CallBack(false,null);
}
...
var GetPageRow = function ( CurPage , PageSize , Filter , CallBack ) {
    ...
    var Sql = "Select *  from UserPoint  where " + Filter + "  limit " + (PageSize * (CurPage - 1)) + "," + PageSize + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var GetPageRow_Field = function ( Field , CurPage , PageSize , Filter , CallBack ) {
    if(Filter=="")  Filter="1=1";
    var Sql = "Select " + Field + "  from UserPoint  where " + Filter + "  limit " + (PageSize * (CurPage - 1)) + "," + PageSize + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports.GetPageRow=function(){
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/UserPoint.js=>GetPageRow 缺少参数");
    CallBack(false,null);
}
