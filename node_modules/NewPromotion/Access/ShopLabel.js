...
var GetRsCount=function(Filter,CallBack){
    var Sql = "Select Count(*) as Count From ShopLabel Where " + Filter + "";
...
exports.GetRsCount = function () {
    ...
    console.log("Access/ShopLabel.js=>GetRsCount 缺少参数");
    CallBack(false,null);
}
/*-----统计求和--------------*/
var Sum=function(Field,Filter,CallBack){
    var Sql = "Select Sum("+Field+") as SumCount From ShopLabel Where "+Filter+"";
    client.Query ( Sql , function ( err , Result ) {
...
exports.Sum = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/ShopLabel.js=>Sum 缺少参数");
    CallBack(false,null);
}

/*-----查询所有记录--------------*/
var SelectAll = function ( CallBack ) {
    var Sql = "Select * From ShopLabel";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var SelectAll_Field = function (Field, CallBack ) {
    var Sql = "Select "+Field+" From ShopLabel";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var SelectAllByOrder = function (Field ,  Order , CallBack ) {
    var Sql = "Select "+Field+" From ShopLabel  Order By " + Order;
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports.SelectAll = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/ShopLabel.js=>SelectAll 缺少参数");
    CallBack(false,null);
}
/*-----根据关键字查询记录--------------*/

var Select = function ( LabelID , CallBack ) {
    var Sql = "Select * From ShopLabel Where LabelID=?LabelID";
    var Values = {};
    ...
    var Sql = "Select "+Field+" From ShopLabel Where LabelID=?LabelID";
    var Values = {};
    Values.LabelID = LabelID;
    client.Query ( Sql , Values , function ( err , Result ) {
        if ( Result.length > 0 ) {
...
exports.Select = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/ShopLabel.js=>Select 缺少参数");
    CallBack(false,null);
}

/*-----根据条件查询记录--------------*/
var SelectByFilter = function ( Filter , CallBack ) {
    var Sql = "Select * From ShopLabel Where " + Filter + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var SelectByFilter_Field = function (Field, Filter , CallBack ) {
    var Sql = "Select "+Field+" From ShopLabel Where " + Filter + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports.SelectByFilter = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/ShopLabel.js=>SelectByFilter 缺少参数");
    CallBack(false,null);
}
...
exports.Insert = function ( Model , CallBack ) {
    var Sql = "Insert Into ShopLabel Set LabelName=?LabelName,LabelParentID=?LabelParentID,IsParent=?IsParent,LabelShopCount=?LabelShopCount,Sort=?Sort ";
...
exports.Update = function ( Model , CallBack ) {
    var Sql = "Update ShopLabel Set  LabelName=?LabelName,LabelParentID=?LabelParentID,IsParent=?IsParent,LabelShopCount=?LabelShopCount,Sort=?Sort Where LabelID=?LabelID";
    client.Query ( Sql , Model , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports.Set_LabelName = function ( LabelID , Value , CallBack ) {
    var Sql = "Update ShopLabel Set LabelName=?LabelName where LabelID=?LabelID";
    var Model = {};
    Model.Value = Value;
...
exports.Set_LabelParentID = function ( LabelID , Value , CallBack ) {
    var Sql = "Update ShopLabel Set LabelParentID=?LabelParentID where LabelID=?LabelID";
    var Model = {};
    Model.Value = Value;
    Model.LabelID = LabelID;
    client.Query ( Sql , Model , function ( err , Result ) {
...
exports.Set_IsParent = function ( LabelID , Value , CallBack ) {
    var Sql = "Update ShopLabel Set IsParent=?IsParent where LabelID=?LabelID";
    var Model = {};
    Model.Value = Value;
    Model.LabelID = LabelID;
    client.Query ( Sql , Model , function ( err , Result ) {
...
/**
 * 更新字段值 LabelShopCount
 * @param Key  主键值 Key:LabelID
 * @param Value LabelShopCount的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_LabelShopCount = function ( LabelID , Value , CallBack ) {
    var Sql = "Update ShopLabel Set LabelShopCount=?LabelShopCount where LabelID=?LabelID";
    var Model = {};
    Model.Value = Value;
    Model.LabelID = LabelID;
    client.Query ( Sql , Model , function ( err , Result ) {
...
exports.Set_Sort = function ( LabelID , Value , CallBack ) {
    var Sql = "Update ShopLabel Set Sort=?Sort where LabelID=?LabelID";
    var Model = {};
    Model.Value = Value;
    Model.LabelID = LabelID;
    client.Query ( Sql , Model , function ( err , Result ) {
...
exports.Delete=function(LabelID,CallBack){
    var Sql = "Delete From ShopLabel Where LabelID=?LabelID";
    var Model={};
    Model.LabelID=LabelID;
    client.Query ( Sql , Model , function ( err , Result ) {
        CallBack ( err , Result );
...
var DeleteByFilter=function(Filter,CallBack){
    var Sql = "Delete From ShopLabel where "+Filter+"";
    client.Query ( Sql  , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports. DeleteByFilter=function(){
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/ShopLabel.js=>DeleteByFilter 缺少参数");
    CallBack(false,null);
}
...
var GetPageRow = function ( CurPage , PageSize , Filter , CallBack ) {
    ...
    var Sql = "Select *  from ShopLabel  where " + Filter + "  limit " + (PageSize * (CurPage - 1)) + "," + PageSize + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var GetPageRow_Field = function ( Field , CurPage , PageSize , Filter , CallBack ) {
    if(Filter=="")  Filter="1=1";
    var Sql = "Select " + Field + "  from ShopLabel  where " + Filter + "  limit " + (PageSize * (CurPage - 1)) + "," + PageSize + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports.GetPageRow=function(){
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/ShopLabel.js=>GetPageRow 缺少参数");
    CallBack(false,null);
}
