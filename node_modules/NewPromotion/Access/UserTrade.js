...
var GetRsCount=function(Filter,CallBack){
    var Sql = "Select Count(*) as Count From UserTrade Where " + Filter + "";
...
exports.GetRsCount = function () {
    ...
    console.log("Access/UserTrade.js=>GetRsCount 缺少参数");
    CallBack(false,null);
}
/*-----统计求和--------------*/
var Sum=function(Field,Filter,CallBack){
    var Sql = "Select Sum("+Field+") as SumCount From UserTrade Where "+Filter+"";
    client.Query ( Sql , function ( err , Result ) {
...
exports.Sum = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/UserTrade.js=>Sum 缺少参数");
    CallBack(false,null);
}

/*-----查询所有记录--------------*/
var SelectAll = function ( CallBack ) {
    var Sql = "Select * From UserTrade";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var SelectAll_Field = function (Field, CallBack ) {
    var Sql = "Select "+Field+" From UserTrade";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var SelectAllByOrder = function (Field ,  Order , CallBack ) {
    var Sql = "Select "+Field+" From UserTrade  Order By " + Order;
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports.SelectAll = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/UserTrade.js=>SelectAll 缺少参数");
    CallBack(false,null);
}
/*-----根据关键字查询记录--------------*/

var Select = function ( ID , CallBack ) {
    var Sql = "Select * From UserTrade Where ID=?ID";
    var Values = {};
    Values.ID = ID;
    client.Query ( Sql , Values , function ( err , Result ) {
        if ( Result.length > 0 ) {
    ...
    var Select_Field = function (Field, ID , CallBack ) {
    var Sql = "Select "+Field+" From UserTrade Where ID=?ID";
    var Values = {};
    Values.ID = ID;
    client.Query ( Sql , Values , function ( err , Result ) {
        if ( Result.length > 0 ) {
...
exports.Select = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/UserTrade.js=>Select 缺少参数");
    CallBack(false,null);
}

/*-----根据条件查询记录--------------*/
var SelectByFilter = function ( Filter , CallBack ) {
    var Sql = "Select * From UserTrade Where " + Filter + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var SelectByFilter_Field = function (Field, Filter , CallBack ) {
    var Sql = "Select "+Field+" From UserTrade Where " + Filter + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports.SelectByFilter = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/UserTrade.js=>SelectByFilter 缺少参数");
    CallBack(false,null);
}
...
exports.Insert = function ( Model , CallBack ) {
    var Sql = "Insert Into UserTrade Set ID=?ID,TradeID=?TradeID,ShopID=?ShopID,ShopName=?ShopName,UserID=?UserID,SrcUserID=?SrcUserID,SrcUserName=?SrcUserName,Fanli=?Fanli,FanliType=?FanliType,Wtime=?Wtime,TradeStatus=?TradeStatus ";
...
exports.Update = function ( Model , CallBack ) {
    var Sql = "Update UserTrade Set  ID=?ID,TradeID=?TradeID,ShopID=?ShopID,ShopName=?ShopName,UserID=?UserID,SrcUserID=?SrcUserID,SrcUserName=?SrcUserName,Fanli=?Fanli,FanliType=?FanliType,Wtime=?Wtime,TradeStatus=?TradeStatus Where ID=?ID";
    client.Query ( Sql , Model , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
/**
 * 更新字段值 ID
 * @param Key  主键值 Key:ID
 * @param Value ID的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_ID = function ( ID , Value , CallBack ) {
    var Sql = "Update UserTrade Set ID=?ID where ID=?ID";
    var Model = {};
    Model.Value = Value;
    Model.ID = ID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * @constructor
 */
exports.Set_TradeID = function ( ID , Value , CallBack ) {
    var Sql = "Update UserTrade Set TradeID=?TradeID where ID=?ID";
    var Model = {};
    Model.Value = Value;
    Model.ID = ID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * @constructor
 */
exports.Set_ShopID = function ( ID , Value , CallBack ) {
    var Sql = "Update UserTrade Set ShopID=?ShopID where ID=?ID";
    var Model = {};
    Model.Value = Value;
    Model.ID = ID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * @constructor
 */
exports.Set_ShopName = function ( ID , Value , CallBack ) {
    var Sql = "Update UserTrade Set ShopName=?ShopName where ID=?ID";
    var Model = {};
    Model.Value = Value;
    Model.ID = ID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * @constructor
 */
exports.Set_UserID = function ( ID , Value , CallBack ) {
    var Sql = "Update UserTrade Set UserID=?UserID where ID=?ID";
    var Model = {};
    Model.Value = Value;
    Model.ID = ID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * 更新字段值 SrcUserID
 * @param Key  主键值 Key:ID
 * @param Value SrcUserID的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_SrcUserID = function ( ID , Value , CallBack ) {
    var Sql = "Update UserTrade Set SrcUserID=?SrcUserID where ID=?ID";
    var Model = {};
    Model.Value = Value;
    Model.ID = ID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * 更新字段值 SrcUserName
 * @param Key  主键值 Key:ID
 * @param Value SrcUserName的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_SrcUserName = function ( ID , Value , CallBack ) {
    var Sql = "Update UserTrade Set SrcUserName=?SrcUserName where ID=?ID";
    var Model = {};
    Model.Value = Value;
    Model.ID = ID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * @constructor
 */
exports.Set_Fanli = function ( ID , Value , CallBack ) {
    var Sql = "Update UserTrade Set Fanli=?Fanli where ID=?ID";
    var Model = {};
    Model.Value = Value;
    Model.ID = ID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * 更新字段值 FanliType
 * @param Key  主键值 Key:ID
 * @param Value FanliType的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_FanliType = function ( ID , Value , CallBack ) {
    var Sql = "Update UserTrade Set FanliType=?FanliType where ID=?ID";
    var Model = {};
    Model.Value = Value;
    Model.ID = ID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * @constructor
 */
exports.Set_Wtime = function ( ID , Value , CallBack ) {
    var Sql = "Update UserTrade Set Wtime=?Wtime where ID=?ID";
    var Model = {};
    Model.Value = Value;
    Model.ID = ID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * @constructor
 */
exports.Set_TradeStatus = function ( ID , Value , CallBack ) {
    var Sql = "Update UserTrade Set TradeStatus=?TradeStatus where ID=?ID";
    var Model = {};
    Model.Value = Value;
    Model.ID = ID;
    client.Query ( Sql , Model , function ( err , Result ) {
...
exports.Delete=function(ID,CallBack){
    var Sql = "Delete From UserTrade Where ID=?ID";
    var Model={};
    Model.ID=ID;
    client.Query ( Sql , Model , function ( err , Result ) {
        CallBack ( err , Result );
...
var DeleteByFilter=function(Filter,CallBack){
    var Sql = "Delete From UserTrade where "+Filter+"";
    client.Query ( Sql  , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports. DeleteByFilter=function(){
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/UserTrade.js=>DeleteByFilter 缺少参数");
    CallBack(false,null);
}
...
var GetPageRow = function ( CurPage , PageSize , Filter , CallBack ) {
    ...
    var Sql = "Select *  from UserTrade  where " + Filter + "  limit " + (PageSize * (CurPage - 1)) + "," + PageSize + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var GetPageRow_Field = function ( Field , CurPage , PageSize , Filter , CallBack ) {
    if(Filter=="")  Filter="1=1";
    var Sql = "Select " + Field + "  from UserTrade  where " + Filter + "  limit " + (PageSize * (CurPage - 1)) + "," + PageSize + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports.GetPageRow=function(){
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/UserTrade.js=>GetPageRow 缺少参数");
    CallBack(false,null);
}
