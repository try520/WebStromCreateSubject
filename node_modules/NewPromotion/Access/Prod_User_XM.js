...
var GetRsCount=function(Filter,CallBack){
    var Sql = "Select Count(*) as Count From Prod_User_XM Where " + Filter + "";
...
exports.GetRsCount = function () {
    ...
    console.log("Access/Prod_User_XM.js=>GetRsCount 缺少参数");
    CallBack(false,null);
}
/*-----统计求和--------------*/
var Sum=function(Field,Filter,CallBack){
    var Sql = "Select Sum("+Field+") as SumCount From Prod_User_XM Where "+Filter+"";
    client.Query ( Sql , function ( err , Result ) {
...
exports.Sum = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/Prod_User_XM.js=>Sum 缺少参数");
    CallBack(false,null);
}

/*-----查询所有记录--------------*/
var SelectAll = function ( CallBack ) {
    var Sql = "Select * From Prod_User_XM";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var SelectAll_Field = function (Field, CallBack ) {
    var Sql = "Select "+Field+" From Prod_User_XM";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var SelectAllByOrder = function (Field ,  Order , CallBack ) {
    var Sql = "Select "+Field+" From Prod_User_XM  Order By " + Order;
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports.SelectAll = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/Prod_User_XM.js=>SelectAll 缺少参数");
    CallBack(false,null);
}
/*-----根据关键字查询记录--------------*/

var Select = function ( ID , CallBack ) {
    var Sql = "Select * From Prod_User_XM Where ID=?ID";
    var Values = {};
    Values.ID = ID;
    client.Query ( Sql , Values , function ( err , Result ) {
        if ( Result.length > 0 ) {
    ...
    var Sql = "Select "+Field+" From Prod_User_XM Where ID=?ID";
    var Values = {};
    Values.ID = ID;
    client.Query ( Sql , Values , function ( err , Result ) {
        if ( Result.length > 0 ) {
...
exports.Select = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/Prod_User_XM.js=>Select 缺少参数");
    CallBack(false,null);
}

/*-----根据条件查询记录--------------*/
var SelectByFilter = function ( Filter , CallBack ) {
    var Sql = "Select * From Prod_User_XM Where " + Filter + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var SelectByFilter_Field = function (Field, Filter , CallBack ) {
    var Sql = "Select "+Field+" From Prod_User_XM Where " + Filter + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports.SelectByFilter = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/Prod_User_XM.js=>SelectByFilter 缺少参数");
    CallBack(false,null);
}
...
exports.Insert = function ( Model , CallBack ) {
    var Sql = "Insert Into Prod_User_XM Set ID=?ID,ProdID=?ProdID,UserID=?UserID,UserNick=?UserNick,Point=?Point,CreateTime=?CreateTime ";
...
exports.Update = function ( Model , CallBack ) {
    var Sql = "Update Prod_User_XM Set  ID=?ID,ProdID=?ProdID,UserID=?UserID,UserNick=?UserNick,Point=?Point,CreateTime=?CreateTime Where ID=?ID";
    client.Query ( Sql , Model , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports.Set_ID = function ( ID , Value , CallBack ) {
    var Sql = "Update Prod_User_XM Set ID=?ID where ID=?ID";
    var Model = {};
    Model.Value = Value;
    Model.ID = ID;
    client.Query ( Sql , Model , function ( err , Result ) {
...
exports.Set_ProdID = function ( ID , Value , CallBack ) {
    var Sql = "Update Prod_User_XM Set ProdID=?ProdID where ID=?ID";
    var Model = {};
    Model.Value = Value;
    Model.ID = ID;
    client.Query ( Sql , Model , function ( err , Result ) {
...
exports.Set_UserID = function ( ID , Value , CallBack ) {
    var Sql = "Update Prod_User_XM Set UserID=?UserID where ID=?ID";
    var Model = {};
    Model.Value = Value;
    Model.ID = ID;
    client.Query ( Sql , Model , function ( err , Result ) {
...
exports.Set_UserNick = function ( ID , Value , CallBack ) {
    var Sql = "Update Prod_User_XM Set UserNick=?UserNick where ID=?ID";
    var Model = {};
    Model.Value = Value;
    Model.ID = ID;
    client.Query ( Sql , Model , function ( err , Result ) {
...
exports.Set_Point = function ( ID , Value , CallBack ) {
    var Sql = "Update Prod_User_XM Set Point=?Point where ID=?ID";
    var Model = {};
    Model.Value = Value;
    Model.ID = ID;
    client.Query ( Sql , Model , function ( err , Result ) {
...
exports.Set_CreateTime = function ( ID , Value , CallBack ) {
    var Sql = "Update Prod_User_XM Set CreateTime=?CreateTime where ID=?ID";
    var Model = {};
    Model.Value = Value;
    Model.ID = ID;
    client.Query ( Sql , Model , function ( err , Result ) {
...
exports.Delete=function(ID,CallBack){
    var Sql = "Delete From Prod_User_XM Where ID=?ID";
    var Model={};
    Model.ID=ID;
    client.Query ( Sql , Model , function ( err , Result ) {
        CallBack ( err , Result );
...
exports.DeleteAll=function(CallBack){
    var Sql = "Delete From Prod_User_XM";
    client.Query ( Sql  , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var DeleteByFilter=function(Filter,CallBack){
    var Sql = "Delete From Prod_User_XM where "+Filter+"";
    client.Query ( Sql  , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports. DeleteByFilter=function(){
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/Prod_User_XM.js=>DeleteByFilter 缺少参数");
    CallBack(false,null);
}
...
var GetPageRow = function ( CurPage , PageSize , Filter , CallBack ) {
    ...
    var Sql = "Select *  from Prod_User_XM  where " + Filter + "  limit " + (PageSize * (CurPage - 1)) + "," + PageSize + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var GetPageRow_Field = function ( Field , CurPage , PageSize , Filter , CallBack ) {
    if(Filter=="")  Filter="1=1";
    var Sql = "Select " + Field + "  from Prod_User_XM  where " + Filter + "  limit " + (PageSize * (CurPage - 1)) + "," + PageSize + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports.GetPageRow=function(){
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/Prod_User_XM.js=>GetPageRow 缺少参数");
    CallBack(false,null);
}
