...
var GetRsCount=function(Filter,CallBack){
    var Sql = "Select Count(*) as Count From UserInCome Where " + Filter + "";
...
exports.GetRsCount = function () {
    ...
    console.log("Access/UserInCome.js=>GetRsCount 缺少参数");
    CallBack(false,null);
}
/*-----统计求和--------------*/
var Sum=function(Field,Filter,CallBack){
    var Sql = "Select Sum("+Field+") as SumCount From UserInCome Where "+Filter+"";
    client.Query ( Sql , function ( err , Result ) {
...
exports.Sum = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/UserInCome.js=>Sum 缺少参数");
    CallBack(false,null);
}

/*-----查询所有记录--------------*/
var SelectAll = function ( CallBack ) {
    var Sql = "Select * From UserInCome";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var SelectAll_Field = function (Field, CallBack ) {
    var Sql = "Select "+Field+" From UserInCome";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var SelectAllByOrder = function (Field ,  Order , CallBack ) {
    var Sql = "Select "+Field+" From UserInCome  Order By " + Order;
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports.SelectAll = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/UserInCome.js=>SelectAll 缺少参数");
    CallBack(false,null);
}
/*-----根据关键字查询记录--------------*/

var Select = function ( IncomeID , CallBack ) {
    var Sql = "Select * From UserInCome Where IncomeID=?IncomeID";
    var Values = {};
    Values.IncomeID = IncomeID;
    client.Query ( Sql , Values , function ( err , Result ) {
        if ( Result.length > 0 ) {
    ...
    var Select_Field = function (Field, IncomeID , CallBack ) {
    var Sql = "Select "+Field+" From UserInCome Where IncomeID=?IncomeID";
    var Values = {};
    Values.IncomeID = IncomeID;
    client.Query ( Sql , Values , function ( err , Result ) {
        if ( Result.length > 0 ) {
...
exports.Select = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/UserInCome.js=>Select 缺少参数");
    CallBack(false,null);
}

/*-----根据条件查询记录--------------*/
var SelectByFilter = function ( Filter , CallBack ) {
    var Sql = "Select * From UserInCome Where " + Filter + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var SelectByFilter_Field = function (Field, Filter , CallBack ) {
    var Sql = "Select "+Field+" From UserInCome Where " + Filter + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports.SelectByFilter = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/UserInCome.js=>SelectByFilter 缺少参数");
    CallBack(false,null);
}
...
exports.Insert = function ( Model , CallBack ) {
    var Sql = "Insert Into UserInCome Set Money=?Money,UserID=?UserID,Wtime=?Wtime,Remark=?Remark,IncomeType=?IncomeType ";
...
exports.Update = function ( Model , CallBack ) {
    var Sql = "Update UserInCome Set  Money=?Money,UserID=?UserID,Wtime=?Wtime,Remark=?Remark,IncomeType=?IncomeType Where IncomeID=?IncomeID";
    client.Query ( Sql , Model , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
/**
 * 更新字段值 Money
 * @param Key  主键值 Key:IncomeID
 * @param Value Money的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_Money = function ( IncomeID , Value , CallBack ) {
    var Sql = "Update UserInCome Set Money=?Money where IncomeID=?IncomeID";
    var Model = {};
    Model.Value = Value;
 ...
 * @constructor
 */
exports.Set_UserID = function ( IncomeID , Value , CallBack ) {
    var Sql = "Update UserInCome Set UserID=?UserID where IncomeID=?IncomeID";
    var Model = {};
    Model.Value = Value;
    Model.IncomeID = IncomeID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * @constructor
 */
exports.Set_Wtime = function ( IncomeID , Value , CallBack ) {
    var Sql = "Update UserInCome Set Wtime=?Wtime where IncomeID=?IncomeID";
    var Model = {};
    Model.Value = Value;
    Model.IncomeID = IncomeID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * 更新字段值 Remark
 * @param Key  主键值 Key:IncomeID
 * @param Value Remark的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_Remark = function ( IncomeID , Value , CallBack ) {
    var Sql = "Update UserInCome Set Remark=?Remark where IncomeID=?IncomeID";
    var Model = {};
    Model.Value = Value;
    Model.IncomeID = IncomeID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * 更新字段值 IncomeType
 * @param Key  主键值 Key:IncomeID
 * @param Value IncomeType的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_IncomeType = function ( IncomeID , Value , CallBack ) {
    var Sql = "Update UserInCome Set IncomeType=?IncomeType where IncomeID=?IncomeID";
    var Model = {};
    Model.Value = Value;
    Model.IncomeID = IncomeID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * @constructor
 */
exports.Delete=function(IncomeID,CallBack){
    var Sql = "Delete From UserInCome Where IncomeID=?IncomeID";
    var Model={};
    Model.IncomeID=IncomeID;
    client.Query ( Sql , Model , function ( err , Result ) {
        CallBack ( err , Result );
...
exports.DeleteAll=function(CallBack){
    var Sql = "Delete From UserInCome";
    client.Query ( Sql  , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var DeleteByFilter=function(Filter,CallBack){
    var Sql = "Delete From UserInCome where "+Filter+"";
    client.Query ( Sql  , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports. DeleteByFilter=function(){
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/UserInCome.js=>DeleteByFilter 缺少参数");
    CallBack(false,null);
}
...
var GetPageRow = function ( CurPage , PageSize , Filter , CallBack ) {
    ...
    var Sql = "Select *  from UserInCome  where " + Filter + "  limit " + (PageSize * (CurPage - 1)) + "," + PageSize + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var GetPageRow_Field = function ( Field , CurPage , PageSize , Filter , CallBack ) {
    if(Filter=="")  Filter="1=1";
    var Sql = "Select " + Field + "  from UserInCome  where " + Filter + "  limit " + (PageSize * (CurPage - 1)) + "," + PageSize + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports.GetPageRow=function(){
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/UserInCome.js=>GetPageRow 缺少参数");
    CallBack(false,null);
}
