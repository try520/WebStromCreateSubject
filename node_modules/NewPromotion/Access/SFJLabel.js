...
var GetRsCount=function(Filter,CallBack){
    var Sql = "Select Count(*) as Count From SFJLabel Where " + Filter + "";
...
exports.GetRsCount = function () {
    ...
    console.log("Access/SFJLabel.js=>GetRsCount 缺少参数");
    CallBack(false,null);
}
/*-----统计求和--------------*/
var Sum=function(Field,Filter,CallBack){
    var Sql = "Select Sum("+Field+") as SumCount From SFJLabel Where "+Filter+"";
    client.Query ( Sql , function ( err , Result ) {
...
exports.Sum = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/SFJLabel.js=>Sum 缺少参数");
    CallBack(false,null);
}

/*-----查询所有记录--------------*/
var SelectAll = function ( CallBack ) {
    var Sql = "Select * From SFJLabel";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var SelectAll_Field = function (Field, CallBack ) {
    var Sql = "Select "+Field+" From SFJLabel";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var SelectAllByOrder = function (Field ,  Order , CallBack ) {
    var Sql = "Select "+Field+" From SFJLabel  Order By " + Order;
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports.SelectAll = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/SFJLabel.js=>SelectAll 缺少参数");
    CallBack(false,null);
}
/*-----根据关键字查询记录--------------*/

var Select = function ( SFJLabelID , CallBack ) {
    var Sql = "Select * From SFJLabel Where SFJLabelID=?SFJLabelID";
    var Values = {};
    Values.SFJLabelID = SFJLabelID;
    client.Query ( Sql , Values , function ( err , Result ) {
        if ( Result.length > 0 ) {
    ...
    var Select_Field = function (Field, SFJLabelID , CallBack ) {
    var Sql = "Select "+Field+" From SFJLabel Where SFJLabelID=?SFJLabelID";
    var Values = {};
    Values.SFJLabelID = SFJLabelID;
    client.Query ( Sql , Values , function ( err , Result ) {
        if ( Result.length > 0 ) {
...
exports.Select = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/SFJLabel.js=>Select 缺少参数");
    CallBack(false,null);
}

/*-----根据条件查询记录--------------*/
var SelectByFilter = function ( Filter , CallBack ) {
    var Sql = "Select * From SFJLabel Where " + Filter + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var SelectByFilter_Field = function (Field, Filter , CallBack ) {
    var Sql = "Select "+Field+" From SFJLabel Where " + Filter + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports.SelectByFilter = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/SFJLabel.js=>SelectByFilter 缺少参数");
    CallBack(false,null);
}
...
exports.Insert = function ( Model , CallBack ) {
    var Sql = "Insert Into SFJLabel Set SiteLabelID=?SiteLabelID,LabelName=?LabelName,Sort=?Sort,SFJCount=?SFJCount ";
...
exports.Update = function ( Model , CallBack ) {
    var Sql = "Update SFJLabel Set  SiteLabelID=?SiteLabelID,LabelName=?LabelName,Sort=?Sort,SFJCount=?SFJCount Where SFJLabelID=?SFJLabelID";
    client.Query ( Sql , Model , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
/**
 * 更新字段值 SiteLabelID
 * @param Key  主键值 Key:SFJLabelID
 * @param Value SiteLabelID的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_SiteLabelID = function ( SFJLabelID , Value , CallBack ) {
    var Sql = "Update SFJLabel Set SiteLabelID=?SiteLabelID where SFJLabelID=?SFJLabelID";
    var Model = {};
    Model.Value = Value;
    Model.SFJLabelID = SFJLabelID;
    client.Query ( Sql , Model , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
 ...
 * @constructor
 */
exports.Set_LabelName = function ( SFJLabelID , Value , CallBack ) {
    var Sql = "Update SFJLabel Set LabelName=?LabelName where SFJLabelID=?SFJLabelID";
    var Model = {};
    Model.Value = Value;
    Model.SFJLabelID = SFJLabelID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * @constructor
 */
exports.Set_Sort = function ( SFJLabelID , Value , CallBack ) {
    var Sql = "Update SFJLabel Set Sort=?Sort where SFJLabelID=?SFJLabelID";
    var Model = {};
    Model.Value = Value;
    Model.SFJLabelID = SFJLabelID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * 更新字段值 SFJCount
 * @param Key  主键值 Key:SFJLabelID
 * @param Value SFJCount的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_SFJCount = function ( SFJLabelID , Value , CallBack ) {
    var Sql = "Update SFJLabel Set SFJCount=?SFJCount where SFJLabelID=?SFJLabelID";
    var Model = {};
    Model.Value = Value;
    Model.SFJLabelID = SFJLabelID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * @constructor
 */
exports.Delete=function(SFJLabelID,CallBack){
    var Sql = "Delete From SFJLabel Where SFJLabelID=?SFJLabelID";
    var Model={};
    Model.SFJLabelID=SFJLabelID;
    client.Query ( Sql , Model , function ( err , Result ) {
        CallBack ( err , Result );
...
var DeleteByFilter=function(Filter,CallBack){
    var Sql = "Delete From SFJLabel where "+Filter+"";
    client.Query ( Sql  , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports. DeleteByFilter=function(){
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/SFJLabel.js=>DeleteByFilter 缺少参数");
    CallBack(false,null);
}
...
var GetPageRow = function ( CurPage , PageSize , Filter , CallBack ) {
    ...
    var Sql = "Select *  from SFJLabel  where " + Filter + "  limit " + (PageSize * (CurPage - 1)) + "," + PageSize + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var GetPageRow_Field = function ( Field , CurPage , PageSize , Filter , CallBack ) {
    if(Filter=="")  Filter="1=1";
    var Sql = "Select " + Field + "  from SFJLabel  where " + Filter + "  limit " + (PageSize * (CurPage - 1)) + "," + PageSize + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports.GetPageRow=function(){
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/SFJLabel.js=>GetPageRow 缺少参数");
    CallBack(false,null);
}
