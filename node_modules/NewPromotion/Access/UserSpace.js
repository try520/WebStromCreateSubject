...
var GetRsCount=function(Filter,CallBack){
    var Sql = "Select Count(*) as Count From UserSpace Where " + Filter + "";
...
exports.GetRsCount = function () {
    ...
    console.log("Access/UserSpace.js=>GetRsCount 缺少参数");
    CallBack(false,null);
}
/*-----统计求和--------------*/
var Sum=function(Field,Filter,CallBack){
    var Sql = "Select Sum("+Field+") as SumCount From UserSpace Where "+Filter+"";
    client.Query ( Sql , function ( err , Result ) {
...
exports.Sum = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/UserSpace.js=>Sum 缺少参数");
    CallBack(false,null);
}

/*-----查询所有记录--------------*/
var SelectAll = function ( CallBack ) {
    var Sql = "Select * From UserSpace";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var SelectAll_Field = function (Field, CallBack ) {
    var Sql = "Select "+Field+" From UserSpace";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var SelectAllByOrder = function (Field ,  Order , CallBack ) {
    var Sql = "Select "+Field+" From UserSpace  Order By " + Order;
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports.SelectAll = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/UserSpace.js=>SelectAll 缺少参数");
    CallBack(false,null);
}
/*-----根据关键字查询记录--------------*/

var Select = function ( UserID , CallBack ) {
    var Sql = "Select * From UserSpace Where UserID=?UserID";
    var Values = {};
    ...
    var Sql = "Select "+Field+" From UserSpace Where UserID=?UserID";
    var Values = {};
    Values.UserID = UserID;
    client.Query ( Sql , Values , function ( err , Result ) {
        if ( Result.length > 0 ) {
...
exports.Select = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/UserSpace.js=>Select 缺少参数");
    CallBack(false,null);
}

/*-----根据条件查询记录--------------*/
var SelectByFilter = function ( Filter , CallBack ) {
    var Sql = "Select * From UserSpace Where " + Filter + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var SelectByFilter_Field = function (Field, Filter , CallBack ) {
    var Sql = "Select "+Field+" From UserSpace Where " + Filter + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports.SelectByFilter = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/UserSpace.js=>SelectByFilter 缺少参数");
    CallBack(false,null);
}
...
exports.Insert = function ( Model , CallBack ) {
    var Sql = "Insert Into UserSpace Set UserID=?UserID,SpaceBgID=?SpaceBgID,SpaceXMCount=?SpaceXMCount,SpaceMGCount=?SpaceMGCount,SpaceShareCount=?SpaceShareCount,SpaceSFJCount=?SpaceSFJCount,SpaceXYCount=?SpaceXYCount,SpaceQYJCount=?SpaceQYJCount,UserSign=?UserSign ";
...
exports.Update = function ( Model , CallBack ) {
    var Sql = "Update UserSpace Set  UserID=?UserID,SpaceBgID=?SpaceBgID,SpaceXMCount=?SpaceXMCount,SpaceMGCount=?SpaceMGCount,SpaceShareCount=?SpaceShareCount,SpaceSFJCount=?SpaceSFJCount,SpaceXYCount=?SpaceXYCount,SpaceQYJCount=?SpaceQYJCount,UserSign=?UserSign Where UserID=?UserID";
    client.Query ( Sql , Model , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
 ...
 * @constructor
 */
exports.Set_UserID = function ( UserID , Value , CallBack ) {
    var Sql = "Update UserSpace Set UserID=?UserID where UserID=?UserID";
    var Model = {};
    Model.Value = Value;
    Model.UserID = UserID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * 更新字段值 SpaceBgID
 * @param Key  主键值 Key:UserID
 * @param Value SpaceBgID的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_SpaceBgID = function ( UserID , Value , CallBack ) {
    var Sql = "Update UserSpace Set SpaceBgID=?SpaceBgID where UserID=?UserID";
    var Model = {};
    Model.Value = Value;
    Model.UserID = UserID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * 更新字段值 SpaceXMCount
 * @param Key  主键值 Key:UserID
 * @param Value SpaceXMCount的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_SpaceXMCount = function ( UserID , Value , CallBack ) {
    var Sql = "Update UserSpace Set SpaceXMCount=?SpaceXMCount where UserID=?UserID";
    var Model = {};
    Model.Value = Value;
    Model.UserID = UserID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * 更新字段值 SpaceMGCount
 * @param Key  主键值 Key:UserID
 * @param Value SpaceMGCount的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_SpaceMGCount = function ( UserID , Value , CallBack ) {
    var Sql = "Update UserSpace Set SpaceMGCount=?SpaceMGCount where UserID=?UserID";
    var Model = {};
    Model.Value = Value;
    Model.UserID = UserID;
    client.Query ( Sql , Model , function ( err , Result ) {
...
/**
 * 更新字段值 SpaceShareCount
 * @param Key  主键值 Key:UserID
 * @param Value SpaceShareCount的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_SpaceShareCount = function ( UserID , Value , CallBack ) {
    var Sql = "Update UserSpace Set SpaceShareCount=?SpaceShareCount where UserID=?UserID";
    var Model = {};
    Model.Value = Value;
    Model.UserID = UserID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * 更新字段值 SpaceSFJCount
 * @param Key  主键值 Key:UserID
 * @param Value SpaceSFJCount的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_SpaceSFJCount = function ( UserID , Value , CallBack ) {
    var Sql = "Update UserSpace Set SpaceSFJCount=?SpaceSFJCount where UserID=?UserID";
    var Model = {};
    Model.Value = Value;
    Model.UserID = UserID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * 更新字段值 SpaceXYCount
 * @param Key  主键值 Key:UserID
 * @param Value SpaceXYCount的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_SpaceXYCount = function ( UserID , Value , CallBack ) {
    var Sql = "Update UserSpace Set SpaceXYCount=?SpaceXYCount where UserID=?UserID";
    var Model = {};
    Model.Value = Value;
    Model.UserID = UserID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * 更新字段值 SpaceQYJCount
 * @param Key  主键值 Key:UserID
 * @param Value SpaceQYJCount的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_SpaceQYJCount = function ( UserID , Value , CallBack ) {
    var Sql = "Update UserSpace Set SpaceQYJCount=?SpaceQYJCount where UserID=?UserID";
    var Model = {};
    Model.Value = Value;
    Model.UserID = UserID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * 更新字段值 UserSign
 * @param Key  主键值 Key:UserID
 * @param Value UserSign的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_UserSign = function ( UserID , Value , CallBack ) {
    var Sql = "Update UserSpace Set UserSign=?UserSign where UserID=?UserID";
    var Model = {};
    Model.Value = Value;
    Model.UserID = UserID;
    client.Query ( Sql , Model , function ( err , Result ) {
...
exports.Delete=function(UserID,CallBack){
    var Sql = "Delete From UserSpace Where UserID=?UserID";
    var Model={};
    Model.UserID=UserID;
    client.Query ( Sql , Model , function ( err , Result ) {
        CallBack ( err , Result );
...
var DeleteByFilter=function(Filter,CallBack){
    var Sql = "Delete From UserSpace where "+Filter+"";
    client.Query ( Sql  , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports. DeleteByFilter=function(){
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/UserSpace.js=>DeleteByFilter 缺少参数");
    CallBack(false,null);
}
...
var GetPageRow = function ( CurPage , PageSize , Filter , CallBack ) {
    ...
    var Sql = "Select *  from UserSpace  where " + Filter + "  limit " + (PageSize * (CurPage - 1)) + "," + PageSize + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var GetPageRow_Field = function ( Field , CurPage , PageSize , Filter , CallBack ) {
    if(Filter=="")  Filter="1=1";
    var Sql = "Select " + Field + "  from UserSpace  where " + Filter + "  limit " + (PageSize * (CurPage - 1)) + "," + PageSize + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports.GetPageRow=function(){
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/UserSpace.js=>GetPageRow 缺少参数");
    CallBack(false,null);
}
