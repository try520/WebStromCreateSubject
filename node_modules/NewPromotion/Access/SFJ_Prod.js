...
var GetRsCount=function(Filter,CallBack){
    var Sql = "Select Count(*) as Count From SFJ_Prod Where " + Filter + "";
...
exports.GetRsCount = function () {
    ...
    console.log("Access/SFJ_Prod.js=>GetRsCount 缺少参数");
    CallBack(false,null);
}
/*-----统计求和--------------*/
var Sum=function(Field,Filter,CallBack){
    var Sql = "Select Sum("+Field+") as SumCount From SFJ_Prod Where "+Filter+"";
    client.Query ( Sql , function ( err , Result ) {
...
exports.Sum = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/SFJ_Prod.js=>Sum 缺少参数");
    CallBack(false,null);
}

/*-----查询所有记录--------------*/
var SelectAll = function ( CallBack ) {
    var Sql = "Select * From SFJ_Prod";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var SelectAll_Field = function (Field, CallBack ) {
    var Sql = "Select "+Field+" From SFJ_Prod";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var SelectAllByOrder = function (Field ,  Order , CallBack ) {
    var Sql = "Select "+Field+" From SFJ_Prod  Order By " + Order;
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports.SelectAll = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/SFJ_Prod.js=>SelectAll 缺少参数");
    CallBack(false,null);
}
/*-----根据关键字查询记录--------------*/

var Select = function ( ID , CallBack ) {
    var Sql = "Select * From SFJ_Prod Where ID=?ID";
    var Values = {};
    Values.ID = ID;
    client.Query ( Sql , Values , function ( err , Result ) {
        if ( Result.length > 0 ) {
    ...
    var Sql = "Select "+Field+" From SFJ_Prod Where ID=?ID";
    var Values = {};
    Values.ID = ID;
    client.Query ( Sql , Values , function ( err , Result ) {
        if ( Result.length > 0 ) {
...
exports.Select = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/SFJ_Prod.js=>Select 缺少参数");
    CallBack(false,null);
}

/*-----根据条件查询记录--------------*/
var SelectByFilter = function ( Filter , CallBack ) {
    var Sql = "Select * From SFJ_Prod Where " + Filter + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var SelectByFilter_Field = function (Field, Filter , CallBack ) {
    var Sql = "Select "+Field+" From SFJ_Prod Where " + Filter + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports.SelectByFilter = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/SFJ_Prod.js=>SelectByFilter 缺少参数");
    CallBack(false,null);
}
...
exports.Insert = function ( Model , CallBack ) {
    var Sql = "Insert Into SFJ_Prod Set ID=?ID,Type=?Type,ProdID=?ProdID,UserID=?UserID,UserName=?UserName,CreateTime=?CreateTime,SFJ_ID=?SFJ_ID ";
...
exports.Update = function ( Model , CallBack ) {
    var Sql = "Update SFJ_Prod Set  ID=?ID,Type=?Type,ProdID=?ProdID,UserID=?UserID,UserName=?UserName,CreateTime=?CreateTime,SFJ_ID=?SFJ_ID Where ID=?ID";
    client.Query ( Sql , Model , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports.Set_ID = function ( ID , Value , CallBack ) {
    var Sql = "Update SFJ_Prod Set ID=?ID where ID=?ID";
    var Model = {};
    Model.Value = Value;
    Model.ID = ID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * @constructor
 */
exports.Set_Type = function ( ID , Value , CallBack ) {
    var Sql = "Update SFJ_Prod Set Type=?Type where ID=?ID";
    var Model = {};
    Model.Value = Value;
    Model.ID = ID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * 更新字段值 ProdID
 * @param Key  主键值 Key:ID
 * @param Value ProdID的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_ProdID = function ( ID , Value , CallBack ) {
    var Sql = "Update SFJ_Prod Set ProdID=?ProdID where ID=?ID";
    var Model = {};
    Model.Value = Value;
    Model.ID = ID;
    client.Query ( Sql , Model , function ( err , Result ) {
...
exports.Set_UserID = function ( ID , Value , CallBack ) {
    var Sql = "Update SFJ_Prod Set UserID=?UserID where ID=?ID";
    var Model = {};
    Model.Value = Value;
    Model.ID = ID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * @constructor
 */
exports.Set_UserName = function ( ID , Value , CallBack ) {
    var Sql = "Update SFJ_Prod Set UserName=?UserName where ID=?ID";
    var Model = {};
    Model.Value = Value;
    Model.ID = ID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * @constructor
 */
exports.Set_CreateTime = function ( ID , Value , CallBack ) {
    var Sql = "Update SFJ_Prod Set CreateTime=?CreateTime where ID=?ID";
    var Model = {};
    Model.Value = Value;
    Model.ID = ID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * 更新字段值 SFJ_ID
 * @param Key  主键值 Key:ID
 * @param Value SFJ_ID的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_SFJ_ID = function ( ID , Value , CallBack ) {
    var Sql = "Update SFJ_Prod Set SFJ_ID=?SFJ_ID where ID=?ID";
    var Model = {};
    Model.Value = Value;
    Model.ID = ID;
    client.Query ( Sql , Model , function ( err , Result ) {
...
exports.Delete=function(ID,CallBack){
    var Sql = "Delete From SFJ_Prod Where ID=?ID";
    var Model={};
    Model.ID=ID;
    client.Query ( Sql , Model , function ( err , Result ) {
        CallBack ( err , Result );
...
var DeleteByFilter=function(Filter,CallBack){
    var Sql = "Delete From SFJ_Prod where "+Filter+"";
    client.Query ( Sql  , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports. DeleteByFilter=function(){
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/SFJ_Prod.js=>DeleteByFilter 缺少参数");
    CallBack(false,null);
}
...
var GetPageRow = function ( CurPage , PageSize , Filter , CallBack ) {
    ...
    var Sql = "Select *  from SFJ_Prod  where " + Filter + "  limit " + (PageSize * (CurPage - 1)) + "," + PageSize + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var GetPageRow_Field = function ( Field , CurPage , PageSize , Filter , CallBack ) {
    if(Filter=="")  Filter="1=1";
    var Sql = "Select " + Field + "  from SFJ_Prod  where " + Filter + "  limit " + (PageSize * (CurPage - 1)) + "," + PageSize + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports.GetPageRow=function(){
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/SFJ_Prod.js=>GetPageRow 缺少参数");
    CallBack(false,null);
}
