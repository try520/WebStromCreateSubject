...
var GetRsCount=function(Filter,CallBack){
    var Sql = "Select Count(*) as Count From TmallTmCat Where " + Filter + "";
...
exports.GetRsCount = function () {
    ...
    console.log("Access/TmallTmCat.js=>GetRsCount 缺少参数");
    CallBack(false,null);
}
/*-----统计求和--------------*/
var Sum=function(Field,Filter,CallBack){
    var Sql = "Select Sum("+Field+") as SumCount From TmallTmCat Where "+Filter+"";
    client.Query ( Sql , function ( err , Result ) {
...
exports.Sum = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/TmallTmCat.js=>Sum 缺少参数");
    CallBack(false,null);
}

/*-----查询所有记录--------------*/
var SelectAll = function ( CallBack ) {
    var Sql = "Select * From TmallTmCat";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var SelectAll_Field = function (Field, CallBack ) {
    var Sql = "Select "+Field+" From TmallTmCat";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var SelectAllByOrder = function (Field ,  Order , CallBack ) {
    var Sql = "Select "+Field+" From TmallTmCat  Order By " + Order;
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports.SelectAll = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/TmallTmCat.js=>SelectAll 缺少参数");
    CallBack(false,null);
}
/*-----根据关键字查询记录--------------*/

var Select = function ( CatID , CallBack ) {
    var Sql = "Select * From TmallTmCat Where CatID=?CatID";
    var Values = {};
    Values.CatID = CatID;
    client.Query ( Sql , Values , function ( err , Result ) {
        if ( Result.length > 0 ) {
    ...
    var Select_Field = function (Field, CatID , CallBack ) {
    var Sql = "Select "+Field+" From TmallTmCat Where CatID=?CatID";
    var Values = {};
    Values.CatID = CatID;
    client.Query ( Sql , Values , function ( err , Result ) {
        if ( Result.length > 0 ) {
...
exports.Select = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/TmallTmCat.js=>Select 缺少参数");
    CallBack(false,null);
}

/*-----根据条件查询记录--------------*/
var SelectByFilter = function ( Filter , CallBack ) {
    var Sql = "Select * From TmallTmCat Where " + Filter + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var SelectByFilter_Field = function (Field, Filter , CallBack ) {
    var Sql = "Select "+Field+" From TmallTmCat Where " + Filter + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports.SelectByFilter = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/TmallTmCat.js=>SelectByFilter 缺少参数");
    CallBack(false,null);
}
...
exports.Insert = function ( Model , CallBack ) {
    var Sql = "Insert Into TmallTmCat Set CatID=?CatID,CatName=?CatName,ParentID=?ParentID ";
...
exports.Update = function ( Model , CallBack ) {
    var Sql = "Update TmallTmCat Set  CatID=?CatID,CatName=?CatName,ParentID=?ParentID Where CatID=?CatID";
    client.Query ( Sql , Model , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
/**
 * 更新字段值 CatID
 * @param Key  主键值 Key:CatID
 * @param Value CatID的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_CatID = function ( CatID , Value , CallBack ) {
    var Sql = "Update TmallTmCat Set CatID=?CatID where CatID=?CatID";
    var Model = {};
    Model.Value = Value;
    Model.CatID = CatID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * 更新字段值 CatName
 * @param Key  主键值 Key:CatID
 * @param Value CatName的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_CatName = function ( CatID , Value , CallBack ) {
    var Sql = "Update TmallTmCat Set CatName=?CatName where CatID=?CatID";
    var Model = {};
    Model.Value = Value;
    Model.CatID = CatID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * @constructor
 */
exports.Set_ParentID = function ( CatID , Value , CallBack ) {
    var Sql = "Update TmallTmCat Set ParentID=?ParentID where CatID=?CatID";
    var Model = {};
    Model.Value = Value;
    Model.CatID = CatID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * @constructor
 */
exports.Delete=function(CatID,CallBack){
    var Sql = "Delete From TmallTmCat Where CatID=?CatID";
    var Model={};
    Model.CatID=CatID;
    client.Query ( Sql , Model , function ( err , Result ) {
        CallBack ( err , Result );
...
exports.DeleteAll=function(CallBack){
    var Sql = "Delete From TmallTmCat";
    client.Query ( Sql  , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var DeleteByFilter=function(Filter,CallBack){
    var Sql = "Delete From TmallTmCat where "+Filter+"";
    client.Query ( Sql  , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports. DeleteByFilter=function(){
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/TmallTmCat.js=>DeleteByFilter 缺少参数");
    CallBack(false,null);
}
...
var GetPageRow = function ( CurPage , PageSize , Filter , CallBack ) {
    ...
    var Sql = "Select *  from TmallTmCat  where " + Filter + "  limit " + (PageSize * (CurPage - 1)) + "," + PageSize + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var GetPageRow_Field = function ( Field , CurPage , PageSize , Filter , CallBack ) {
    if(Filter=="")  Filter="1=1";
    var Sql = "Select " + Field + "  from TmallTmCat  where " + Filter + "  limit " + (PageSize * (CurPage - 1)) + "," + PageSize + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports.GetPageRow=function(){
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/TmallTmCat.js=>GetPageRow 缺少参数");
    CallBack(false,null);
}
