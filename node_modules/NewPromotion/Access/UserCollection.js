...
var GetRsCount=function(Filter,CallBack){
    var Sql = "Select Count(*) as Count From UserCollection Where " + Filter + "";
...
exports.GetRsCount = function () {
    ...
    console.log("Access/UserCollection.js=>GetRsCount 缺少参数");
    CallBack(false,null);
}
/*-----统计求和--------------*/
var Sum=function(Field,Filter,CallBack){
    var Sql = "Select Sum("+Field+") as SumCount From UserCollection Where "+Filter+"";
    client.Query ( Sql , function ( err , Result ) {
...
exports.Sum = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/UserCollection.js=>Sum 缺少参数");
    CallBack(false,null);
}

/*-----查询所有记录--------------*/
var SelectAll = function ( CallBack ) {
    var Sql = "Select * From UserCollection";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var SelectAll_Field = function (Field, CallBack ) {
    var Sql = "Select "+Field+" From UserCollection";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var SelectAllByOrder = function (Field ,  Order , CallBack ) {
    var Sql = "Select "+Field+" From UserCollection  Order By " + Order;
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports.SelectAll = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/UserCollection.js=>SelectAll 缺少参数");
    CallBack(false,null);
}
/*-----根据关键字查询记录--------------*/

var Select = function ( CollectionID , CallBack ) {
    var Sql = "Select * From UserCollection Where CollectionID=?CollectionID";
    var Values = {};
    ...
    var Select_Field = function (Field, CollectionID , CallBack ) {
    var Sql = "Select "+Field+" From UserCollection Where CollectionID=?CollectionID";
    var Values = {};
    Values.CollectionID = CollectionID;
    client.Query ( Sql , Values , function ( err , Result ) {
        if ( Result.length > 0 ) {
...
exports.Select = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/UserCollection.js=>Select 缺少参数");
    CallBack(false,null);
}

/*-----根据条件查询记录--------------*/
var SelectByFilter = function ( Filter , CallBack ) {
    var Sql = "Select * From UserCollection Where " + Filter + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var SelectByFilter_Field = function (Field, Filter , CallBack ) {
    var Sql = "Select "+Field+" From UserCollection Where " + Filter + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports.SelectByFilter = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/UserCollection.js=>SelectByFilter 缺少参数");
    CallBack(false,null);
}
...
exports.Insert = function ( Model , CallBack ) {
    var Sql = "Insert Into UserCollection Set CollectionType=?CollectionType,UserID=?UserID,UserName=?UserName,Tag=?Tag,CreateTime=?CreateTime ";
...
exports.Update = function ( Model , CallBack ) {
    var Sql = "Update UserCollection Set  CollectionType=?CollectionType,UserID=?UserID,UserName=?UserName,Tag=?Tag,CreateTime=?CreateTime Where CollectionID=?CollectionID";
    client.Query ( Sql , Model , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
/**
 * 更新字段值 CollectionType
 * @param Key  主键值 Key:CollectionID
 * @param Value CollectionType的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_CollectionType = function ( CollectionID , Value , CallBack ) {
    var Sql = "Update UserCollection Set CollectionType=?CollectionType where CollectionID=?CollectionID";
    var Model = {};
    Model.Value = Value;
 ...
 * @constructor
 */
exports.Set_UserID = function ( CollectionID , Value , CallBack ) {
    var Sql = "Update UserCollection Set UserID=?UserID where CollectionID=?CollectionID";
    var Model = {};
    Model.Value = Value;
    Model.CollectionID = CollectionID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * @constructor
 */
exports.Set_UserName = function ( CollectionID , Value , CallBack ) {
    var Sql = "Update UserCollection Set UserName=?UserName where CollectionID=?CollectionID";
    var Model = {};
    Model.Value = Value;
    Model.CollectionID = CollectionID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * @constructor
 */
exports.Set_Tag = function ( CollectionID , Value , CallBack ) {
    var Sql = "Update UserCollection Set Tag=?Tag where CollectionID=?CollectionID";
    var Model = {};
    Model.Value = Value;
    Model.CollectionID = CollectionID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * @constructor
 */
exports.Set_CreateTime = function ( CollectionID , Value , CallBack ) {
    var Sql = "Update UserCollection Set CreateTime=?CreateTime where CollectionID=?CollectionID";
    var Model = {};
    Model.Value = Value;
    Model.CollectionID = CollectionID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * @constructor
 */
exports.Delete=function(CollectionID,CallBack){
    var Sql = "Delete From UserCollection Where CollectionID=?CollectionID";
    var Model={};
    Model.CollectionID=CollectionID;
    client.Query ( Sql , Model , function ( err , Result ) {
        CallBack ( err , Result );
...
exports.DeleteAll=function(CallBack){
    var Sql = "Delete From UserCollection";
    client.Query ( Sql  , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var DeleteByFilter=function(Filter,CallBack){
    var Sql = "Delete From UserCollection where "+Filter+"";
    client.Query ( Sql  , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports. DeleteByFilter=function(){
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/UserCollection.js=>DeleteByFilter 缺少参数");
    CallBack(false,null);
}
...
var GetPageRow = function ( CurPage , PageSize , Filter , CallBack ) {
    ...
    var Sql = "Select *  from UserCollection  where " + Filter + "  limit " + (PageSize * (CurPage - 1)) + "," + PageSize + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var GetPageRow_Field = function ( Field , CurPage , PageSize , Filter , CallBack ) {
    if(Filter=="")  Filter="1=1";
    var Sql = "Select " + Field + "  from UserCollection  where " + Filter + "  limit " + (PageSize * (CurPage - 1)) + "," + PageSize + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports.GetPageRow=function(){
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/UserCollection.js=>GetPageRow 缺少参数");
    CallBack(false,null);
}
