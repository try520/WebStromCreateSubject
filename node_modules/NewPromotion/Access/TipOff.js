...
var GetRsCount=function(Filter,CallBack){
    var Sql = "Select Count(*) as Count From TipOff Where " + Filter + "";
...
exports.GetRsCount = function () {
    ...
    console.log("Access/TipOff.js=>GetRsCount 缺少参数");
    CallBack(false,null);
}
/*-----统计求和--------------*/
var Sum=function(Field,Filter,CallBack){
    var Sql = "Select Sum("+Field+") as SumCount From TipOff Where "+Filter+"";
    client.Query ( Sql , function ( err , Result ) {
...
exports.Sum = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/TipOff.js=>Sum 缺少参数");
    CallBack(false,null);
}

/*-----查询所有记录--------------*/
var SelectAll = function ( CallBack ) {
    var Sql = "Select * From TipOff";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var SelectAll_Field = function (Field, CallBack ) {
    var Sql = "Select "+Field+" From TipOff";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var SelectAllByOrder = function (Field ,  Order , CallBack ) {
    var Sql = "Select "+Field+" From TipOff  Order By " + Order;
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports.SelectAll = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/TipOff.js=>SelectAll 缺少参数");
    CallBack(false,null);
}
/*-----根据关键字查询记录--------------*/

var Select = function ( TipOffID , CallBack ) {
    var Sql = "Select * From TipOff Where TipOffID=?TipOffID";
    var Values = {};
    Values.TipOffID = TipOffID;
    client.Query ( Sql , Values , function ( err , Result ) {
        if ( Result.length > 0 ) {
    ...
    var Select_Field = function (Field, TipOffID , CallBack ) {
    var Sql = "Select "+Field+" From TipOff Where TipOffID=?TipOffID";
    var Values = {};
    Values.TipOffID = TipOffID;
    client.Query ( Sql , Values , function ( err , Result ) {
        if ( Result.length > 0 ) {
...
exports.Select = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/TipOff.js=>Select 缺少参数");
    CallBack(false,null);
}

/*-----根据条件查询记录--------------*/
var SelectByFilter = function ( Filter , CallBack ) {
    var Sql = "Select * From TipOff Where " + Filter + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var SelectByFilter_Field = function (Field, Filter , CallBack ) {
    var Sql = "Select "+Field+" From TipOff Where " + Filter + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports.SelectByFilter = function () {
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/TipOff.js=>SelectByFilter 缺少参数");
    CallBack(false,null);
}
...
exports.Insert = function ( Model , CallBack ) {
    var Sql = "Insert Into TipOff Set TipOffID=?TipOffID,TipOffType=?TipOffType,Tag=?Tag,TipOffContent=?TipOffContent,CreateTime=?CreateTime,TipOffUserID=?TipOffUserID,TipOffUserName=?TipOffUserName ";
...
exports.Update = function ( Model , CallBack ) {
    var Sql = "Update TipOff Set  TipOffID=?TipOffID,TipOffType=?TipOffType,Tag=?Tag,TipOffContent=?TipOffContent,CreateTime=?CreateTime,TipOffUserID=?TipOffUserID,TipOffUserName=?TipOffUserName Where TipOffID=?TipOffID";
    client.Query ( Sql , Model , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
/**
 * 更新字段值 TipOffID
 * @param Key  主键值 Key:TipOffID
 * @param Value TipOffID的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_TipOffID = function ( TipOffID , Value , CallBack ) {
    var Sql = "Update TipOff Set TipOffID=?TipOffID where TipOffID=?TipOffID";
    var Model = {};
    Model.Value = Value;
    Model.TipOffID = TipOffID;
    client.Query ( Sql , Model , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
 ...
 * 更新字段值 TipOffType
 * @param Key  主键值 Key:TipOffID
 * @param Value TipOffType的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_TipOffType = function ( TipOffID , Value , CallBack ) {
    var Sql = "Update TipOff Set TipOffType=?TipOffType where TipOffID=?TipOffID";
    var Model = {};
    Model.Value = Value;
    Model.TipOffID = TipOffID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * @constructor
 */
exports.Set_Tag = function ( TipOffID , Value , CallBack ) {
    var Sql = "Update TipOff Set Tag=?Tag where TipOffID=?TipOffID";
    var Model = {};
    Model.Value = Value;
    Model.TipOffID = TipOffID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * 更新字段值 TipOffContent
 * @param Key  主键值 Key:TipOffID
 * @param Value TipOffContent的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_TipOffContent = function ( TipOffID , Value , CallBack ) {
    var Sql = "Update TipOff Set TipOffContent=?TipOffContent where TipOffID=?TipOffID";
    var Model = {};
    Model.Value = Value;
    Model.TipOffID = TipOffID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * @constructor
 */
exports.Set_CreateTime = function ( TipOffID , Value , CallBack ) {
    var Sql = "Update TipOff Set CreateTime=?CreateTime where TipOffID=?TipOffID";
    var Model = {};
    Model.Value = Value;
    Model.TipOffID = TipOffID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * 更新字段值 TipOffUserID
 * @param Key  主键值 Key:TipOffID
 * @param Value TipOffUserID的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_TipOffUserID = function ( TipOffID , Value , CallBack ) {
    var Sql = "Update TipOff Set TipOffUserID=?TipOffUserID where TipOffID=?TipOffID";
    var Model = {};
    Model.Value = Value;
    Model.TipOffID = TipOffID;
    client.Query ( Sql , Model , function ( err , Result ) {
...
/**
 * 更新字段值 TipOffUserName
 * @param Key  主键值 Key:TipOffID
 * @param Value TipOffUserName的值
 * @param CallBack   回调函数Function（err,Result）
 * @constructor
 */
exports.Set_TipOffUserName = function ( TipOffID , Value , CallBack ) {
    var Sql = "Update TipOff Set TipOffUserName=?TipOffUserName where TipOffID=?TipOffID";
    var Model = {};
    Model.Value = Value;
    Model.TipOffID = TipOffID;
    client.Query ( Sql , Model , function ( err , Result ) {
 ...
 * @constructor
 */
exports.Delete=function(TipOffID,CallBack){
    var Sql = "Delete From TipOff Where TipOffID=?TipOffID";
    var Model={};
    Model.TipOffID=TipOffID;
    client.Query ( Sql , Model , function ( err , Result ) {
        CallBack ( err , Result );
...
var DeleteByFilter=function(Filter,CallBack){
    var Sql = "Delete From TipOff where "+Filter+"";
    client.Query ( Sql  , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports. DeleteByFilter=function(){
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/TipOff.js=>DeleteByFilter 缺少参数");
    CallBack(false,null);
}
...
var GetPageRow = function ( CurPage , PageSize , Filter , CallBack ) {
    ...
    var Sql = "Select *  from TipOff  where " + Filter + "  limit " + (PageSize * (CurPage - 1)) + "," + PageSize + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
var GetPageRow_Field = function ( Field , CurPage , PageSize , Filter , CallBack ) {
    if(Filter=="")  Filter="1=1";
    var Sql = "Select " + Field + "  from TipOff  where " + Filter + "  limit " + (PageSize * (CurPage - 1)) + "," + PageSize + "";
    client.Query ( Sql , function ( err , Result ) {
        CallBack ( err , Result );
    } )
}
...
exports.GetPageRow=function(){
    ...
    var CallBack= arguments[arguments.length-1];
    console.log("Access/TipOff.js=>GetPageRow 缺少参数");
    CallBack(false,null);
}
